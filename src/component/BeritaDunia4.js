                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Wilayah Kashmir yang Dikuasai Pakistan Semakin Ingin Bergabung dengan India
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Sabtu, 23 November 2024, 01:30 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_dunia_5} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Peta Kashmir
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Wilayah Kashmir yang diokupasi Pakistan (POK) yang disebut Azad Kashmir atau Kashmir Bebas tidak mengalami kemajuan seperti wilayah Jammu Kashmir di India. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">walau disebut dikelola sebagai wilayah semi-otonom dengan presiden dan majelis legislatif sendiri, namun Azad Kashmir hanya merasakan sedikit otonomi dan mengalami marginalisasi politik, pengabaian ekonomi, dan pelanggaran hak asasi manusia. Infrastruktur wilayah itu juga masih terbelakang, dan fasilitas dasar seperti layanan kesehatan, pendidikan, dan kesempatan kerja sangat kurang.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu setiap perbedaan pendapat politik atau tuntutan untuk otonomi yang lebih besar sering kali ditanggapi dengan tindakan keras oleh negara Pakistan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">BrighterKashmir.com melaporkan, dalam beberapa tahun terakhir terjadi perubahan nyata dalam sentimen masyarakat yang tinggal di POK. Mereka kecewa pada janji-janji Pakistan yang tidak ditepati dan kebijakan-kebijakan yang menindas. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Banyak orang di Azad Kashmir mulai menyuarakan keinginan berintegrasi dengan India. Beberapa faktor telah berkontribusi terhadap perubahan sentimen ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pertama dan terutama adalah kesadaran bahwa kendali Pakistan atas PIOJK tidak banyak membantu meningkatkan kehidupan penduduknya. Kurangnya pembangunan ekonomi dan korupsi yang merajalela telah menyebabkan kemiskinan dan pengangguran yang meluas. Sebaliknya, banyak orang di Azad Kasmir mengamati kemajuan dan pembangunan di wilayah Jammu & Kashmir di bawah pemerintahan India.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Faktor penting lainnya adalah meningkatnya rasa keterasingan budaya dan agama di Azad Kashmir. Pemerintah Pakistan semakin memaksakan agenda Islam radikal di wilayah tersebut, yang sering kali bertentangan dengan praktik-praktik penduduk lokal yang lebih moderat dan berorientasi pada Sufisme.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Hal ini menyebabkan kesenjangan budaya, dengan banyak penduduk merasa bahwa identitas mereka terkikis di bawah kekuasaan Pakistan. Sebaliknya, pendekatan sekuler dan pluralistik India terhadap pemerintahan lebih selaras dengan keragaman budaya dan agama di kawasan tersebut.
                                                    </p>
                                                </div>
