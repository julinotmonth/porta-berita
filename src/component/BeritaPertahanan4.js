                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Indonesia-AS Komitmen Tingkatkan Kerja Sama Militer
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Selasa, 19 November 2024, 04:42 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Panglima TNI Jenderal TNI Agus Subiyanto/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Panglima TNI Jenderal TNI Agus Subiyanto membahas kerja sama bilateral dengan The U.S. Chairmant Of Joint Chiefs Of Staff (CJCS), General Charles Q. Brown, JR melalui video conference, bertempat di ruang Kosasih, Kodam III Siliwangi, Bandung, Jawa barat, Senin, 18 November 2024.                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Mengawali pembicaraan tersebut, Panglima TNI mengucapkan terima kasih atas komitmen Pemerintah AS, Kepala Staf Gabungan USINDOPACOM untuk terus memperkuat hubungan pertahanan bilateral dengan Indonesia terutama pada bidang pertahanan militer.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lebih lanjut, Panglima TNI menanggapi terkait Latihan Gabungan Bersama Super Garuda Shield, yang sebelumnya ada pengusulan peningkatan fasilitas dari USINDOPACOM. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menurutnya, hal tersebut perlu tindak lanjut agar dapat terwujud untuk meningkatkan fasilitas di Pusat Pelatihan Tempur (Puslatpur) TNI AD di Baturaja, Sumatera Selatan.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selanjutnya pada latihan itu, Panglima TNI menginisiasi penambahan latihan Siber guna meningkatkan Penguasaan teknologi.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Mengakhiri Video Conference, kedua belah pihak negara, menyetujui adanya asosiasi yang mampu meningkatkan keakraban hubungan pertahanan militer kedua negara di masa depan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Turut mendampingi Vicon Asintel Panglima TNI Mayjen TNI Rudi Rachmat Nugraha, Asops Panglima TNI Mayjen TNI Gabriel Lema dan Pangdam III/ Siliwangi Mayjen TNI Dadang Arif Abdurahman serta Kapuskersin TNI Laksma TNI Donny Suharto. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPertahanan4;