                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Hasil OTT di Bengkulu Dipaparkan ke Pimpinan KPK Sore Ini
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 09:26 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wakil Ketua KPK, Alexander Marwata/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Tim operasi tangkap tangan (OTT) Komisi Pemberantasan Korupsi (KPK) akan memaparkan hasil penindakannya di Provinsi Bengkulu kepada pimpinan pada Minggu sore, 24 November 2024.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Wakil Ketua KPK, Alexander Marwata membenarkan bahwa pihaknya melakukan kegiatan tangkap tangan atau OTT di wilayah Bengkulu pada Sabtu, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Detailnya baru nanti sore dipaparkan," kata Alex kepada RMOL, Minggu pagi, 24 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Alex mengaku baru mendapatkan informasi bahwa KPK mengamankan 7 orang dalam kegiatan OTT tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ada 7 orang diamankan. Belum tahu siapa saja dan berapa barang bukti yang didapat juga belum tahu," pungkas Alex.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu, Kapolresta Bengkulu, Kombes Deddy Nata membenarkan bahwa Gubernur Bengkulu, Rohidin Mersyah turut dibawa dan diperiksa KPK pada Sabtu malam, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ya memang benar Rohidin masuk. Kita tunggu perkembangan lebih lanjut (dari KPK) ya," kata Deddy kepada wartawan.rmol news logo article
                                                    </p>
                                                </div>
