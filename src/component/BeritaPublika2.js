                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Mau Enggak, Nurut?
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 07:22 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_publika_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi/Foto CNBC
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">PAGI itu, 26 Agustus 2024, udara Jakarta cerah namun gerah. Tepat pukul 11.45, Anies Baswedan tiba di kantor DPP Partai Demokrasi Indonesia Perjuangan (PDIP) di Menteng, penuh percaya diri dalam balutan batik merah. Ia sudah mendengar kabar baik dari kunjungannya dua hari sebelumnya ke kantor DPD PDIP Jakarta di Cakung. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">"Ini akan mulus," pikirnya. Lagi pula, semua tanda tampak mendukung. Mahkamah Konstitusi telah mengubah ketentuan syarat pencalonan gubernur yang 20% dari total suara sah, menjadi 7,5%. Dengan raihan suara PDIP sebesar 14% atau 15 kursi di DPRD Jakarta, harapan Anies pun membumbung. Ia merasa mendapat isyarat kuat bahwa partai ini akan mengusungnya di Pilkada Jakarta.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, siapa yang tahu bahwa lembaran cerita akan berubah menjadi kenangan tragis? Nasib tidak berpihak pada Anies. Pada Senin siang, 26 Agustus, hanya sehari menjelang masa pendaftaran calon Pilkada, harapannya kandas oleh ucapan Megawati, "Mau enggak, nurut."
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Alkisah, dengan langkah yakin, hari itu Anies masuk ke Gedung B di belakang kantor utama PDIP Menteng, langsung menuju lantai 3. Di sana, dia disambut sahabat lamanya, Rano Karno, mantan Gubernur Banten. Obrolan mereka berlangsung lama —dua hingga tiga jam, berdiskusi politik hingga nostalgia Si Doel.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu, di ruang lain, rapat penting sedang berlangsung. Mega, Ketua Umum PDIP, tengah berdiskusi serius dengan para petinggi partai, termasuk di antaranya Pramono Anung, Harto Kristiyanto, Basuki Tjahaja Purnama (Ahok), dan banyak lainnya. Situasi memanas, berbagai argumen dipaparkan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Anies, yang menunggu di luar ruang rapat, masih ditemani Rano Karno. Ia mengepit buku catatan seperti mahasiswa yang siap sidang skripsi. Kemudian seorang petugas mendekati Anies, meminta dia bersiap. Anies mungkin membayangkan momen epik itu: pintu terbuka, Mega menyebut namanya sebagai calon gubernur, dan ruangan bergemuruh dengan tepuk tangan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, kenyataan berbicara lain. Petugas itu kembali dengan wajah sendu, mengabarkan bahwa pertemuan dengan Mega dibatalkan. Tak lama kemudian, dari corong terdengar nama-nama calon PDIP untuk Pilkada diumumkan di aula, tapi tidak ada nama Anies disebut. Anies pun keluar melalui pintu belakang, membawa hati yang lebih berat dari buku catatannya. Harapannya pupus, bersama asa pendukung setianya yang dikenal sebagai Anak-anak Abah.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Apa yang sebenarnya terjadi? Laporan Pramono Anung dari Istana diduga menjadi salah satu biang kerok. Jokowi, melalui Pratikno, dan disampaikan Pramono, mengingatkan bahwa pencalonan Anies berpotensi mengancam posisi Puan Maharani sebagai Ketua DPR. Ahok menambahkan argumen bahwa jika Anies maju, bagaimana cara mengajak Ahoker mendukungnya? Dua keberatan ini cukup untuk membuat Mega mengubah keputusan. 
                                                    </p>
                                                </div>
