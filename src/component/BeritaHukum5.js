                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">KPK Amankan Uang saat OTT 7 Orang di Bengkulu
                                    </h1>
                                </div>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_5} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Jurubicara KPK, Tessa Mahardhika Sugiarto/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Komisi Pemberantasan Korupsi (KPK) mengamankan sejumlah orang dalam kegiatan tangkap tangan atau operasi tangkap tangan (OTT) di lingkungan Pemerintah Provinsi (Pemprov) Bengkulu.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Jurubicara KPK, Tessa Mahardhika Sugiarto mengatakan, pihaknya berhasil mengamankan 7 orang dalam kegiatan OTT yang dilakukan sejak Sabtu, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Dan turut diamankan sejumlah uang," kata Tessa kepada wartawan, Minggu pagi, 24 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun demikian, kata Tessa, jumlah uang yang diamankan tersebut hingga saat ini masih dilakukan perhitungan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Untuk lengkapnya akan disampaikan secara resmi oleh lembaga sore/malam nanti," pungkas Tessa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
