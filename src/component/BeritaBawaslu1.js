                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Gandeng Polisi, Bawaslu Kota Tasikmalaya Bikin Tim Patroli Cegah Politik Uang
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 04:06 WIB</span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Bawaslu Kota Tasikmalaya menggelar Apel Siaga Masa Tenang Di Bali Kota Tasikmalaya, Sabtu, 23 November 2024/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Masuki masa tenang Pilkada Serentak 2024, menjadi fokus Bawaslu untuk mencegah terjadinya segala macam bentuk pelanggaran Pemilu.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Salah satunya praktik politik uang yang masif dalam setiap perhelatan Pilkada.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Terkait itu, Bawaslu Kota Tasikmalaya meningkatkan patroli pengawasan untuk mencegah praktik politik uang tersebut, terutama di masa tenang Pilkada.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Masa tenang berlangsung pada 24-26 November 2024, bakal menjadi fokus utama Bawaslu dalam mengawasi para calon dan tim suksesnya serta masyarakat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ketua Bawaslu Kota Tasikmalaya, Zaky Pratama, menekankan pentingnya upaya ini demi kelancaran masa tenang dan kepatuhan masyarakat terhadap peraturan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
