...
import img_olahraga_8 from "../img/img_olahraga_8.jpeg"
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Semakin Tidak Terbendung, Jon Jones Berhasil Tumbangkan Stipe Miocic
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Selasa, 19 November 2024, 02:45 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Jon Jones melakukan spinning back kick tumbangkan Stipe Miocic/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Petarung UFC Jon Jones berhasil mempertahankan gelar heavyweight setelah menumbangkan Stipe Miocic dalam laga UFC 309 yang diselenggarakan di Amerika Serikat. Jones menumbangkan Miocic pada ronde ke ketiga.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Menariknya duel yang disiarkan secara langsung di Mola ini merupakan pertarungan perdana kedua petarung tersebut di 2024. Keduanya tersebut telah lama absen memasuki octagon. Jones pada 2023 sedangkan Miocic 2021.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di ronde pertama, Jon Jones terlihat sudah mulai mengambil inisiatif serangan dari arah kiri. Namun, Miocic mampu membalasnya dengan tendangan dari kanan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Petarung 37 tahun tersebut mampu mendominasi duel dengan melakukan side mount setelah menjatuhkan Miocic dan mendaratkan sikuan keras tepat di kepala mantan juara kelas berat tersebut hingga berakhirnya ronde pertama.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di ronde kedua, Stipe Miocic mulai melakukan serangan dengan pukulan jab sebelah kiri hingga mengenai Jones. Saling pukul pun terjadi di antara kedua petarung tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Jones terlihat melakukan tendangan dengan kaki bagian dalam dan melakukan beberapa pukulan. Meski demikian, Mioci mampu bertahan dari serangan tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Petarung 42 tahun tersebut sempat menyerang dengan melancarkan beberapa pukulan dan tendangan spinning back kick yang membuat Jones menghindar. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, upaya Miocic tidak membuat Jones menyerah. Sebaliknya, justru situasi berubah ketika Miocic menerima spinning back kick dan pukulan dari Jones.
                                                    </p>
                                                </div>
...
export default BeritaOlahraga8;