                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">UFC 309, Chandler Tumbang di Tangan Oliveira
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 15:51 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Charles Oliveira Vs Michael Chandler/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Mantan juara kelas lightweight, Charles Oliveira (Do Bronx) berhasil meraih hasil positif setelah mengalahkan Michael Chandler (The Iron) dalam tarung UFC 309 di Madison Square Garden, New York, AS.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Do Bronx mampu menaklukkan The Iron dengan angka mutlak 49-46, 49-46, 49-45. Kemenangan ini seakan mengulang duel tiga tahun lalu di UFC 262, di mana Oliveira mampu menang KO dari Chandler.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada pertandingan yang berlangsung Minggu, 17 November 2024, keduanya sempat adu pukul hingga Do Bronx mendapat celah untuk membanting The Iron.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selama ronde, Do Bronx terlihat superior. Petarung asal Brasil ini bahkan memegang kendali hingga hampir memiting leher The Iron di detik-detik terakhir ronde 3.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Masuk ronde 4, Do Bronx kembali mengambil inisiasi serangan sebelum melakukan bantingan di pinggir octagon. Ia menyerang The Iron dari belakang dan sempat mengambil bahu dan leher untuk melakukan kuncian arm triangle.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di ronde 5, situasi sempat berbalik saat The Iron mendaratkan pukulan telak ke wajah Do Bronx. Berbalik dominan, The Iron sempat menindih Do Bronx sambil mendaratkan pukulan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun hingga akhir ronde, juri memutuskan Oliveira menjadi pemenang dengan skor telak. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaOlahraga6;