...
import img_teknoo_4 from "../img/img_teknoo_4.jpg"

function BeritaTekno4 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Perubahan Besar, Apple akan Gunakan Lensa Aperture Variabel di iPhone 18
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Senin, 11 November 2024, 14:30 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi/AP
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Di masa depan pengguna iPhone akan semakin dimanjakan dengan hasil tangkapan kamera di ponsel mereka. Sebuah rumor menyebutkan bahwa Apple akan menggunakan kamera dengan bukaan variabel pada iPhone 17 Air atau Slim di 2025 kelak. </span>
                                </div>
                                                ...
                                                <Row>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/14/644704/hadapi-temu-amazon-luncurkan-haul">
                                                                <img src={terkait_tekno_1} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/14/644704/hadapi-temu-amazon-luncurkan-haul" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Hadapi Temu, Amazon Luncurkan Haul</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/04/643395/pasar-tablet-melonjak-apple-juaranya">
                                                                <img src={terkait_tekno_2} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/04/643395/pasar-tablet-melonjak-apple-juaranya" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Pasar Tablet Melonjak, Apple Juaranya</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/02/643192/wall-street-kompak-naik-saham-amazon-melesat-lebih-dari-6-persen">
                                                                <img src={terkait_tekno_3} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/02/643192/wall-street-kompak-naik-saham-amazon-melesat-lebih-dari-6-persen" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Wall Street Kompak Naik, Saham Amazon Melesat Lebih dari 6 Persen</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/10/26/642331/saham-tesla-dan-amazon-naik-mcdonalds-masih-terus-terjungkal-gara-gara-wabah-e-coli">
                                                                <img src={terkait_tekno_4} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/10/26/642331/saham-tesla-dan-amazon-naik-mcdonalds-masih-terus-terjungkal-gara-gara-wabah-e-coli" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Saham Tesla dan Amazon Naik, McDonald's Masih Terus Terjungkal Gara-gara Wabah E Coli</span>
                                                        </Link>
                                                    </Col>
                                                </Row>
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Analis terkenal Ming-Chi Kuo menguatkan kabar tersebut dengan mengatakan bahwa Apple akan mempertahankan peningkatan kamera yang mencengangkan itu untuk seri iPhone 18.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ini menjadi menarik dan menimbulkan banyak pertanyaan tentang bagaimana kamera yang bergelombang dengan bukaan variabel akan muat di bagian belakang ponsel yang nilai tambah utamanya adalah tampilannya yang tipis dan elegan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Oleh karena itu, pengenalan kamera sudut lebar pertama Apple dengan bukaan variabel pada seri iPhone 18 jauh lebih mungkin terjadi daripada melihat peningkatan drastis ini tahun depan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kamera dengan bukaan variabel bukanlah hal baru dalam fotografi ponsel pintar. Contoh terbaru adalah seri Pura 70 baru dari Huawei yang memiliki kamera utama dengan bukaan variabel dari f/1.6 hingga f/4.0, dilengkapi dengan teknologi anti-guncangan sensor-shift.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Huawei juga merupakan yang pertama kali memperkenalkan ponsel dengan kamera bukaan variabel di dunia melalui Honor 6 hampir satu dekade lalu.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bahkan Samsung pernah memiliki kamera seperti itu pada seri Galaxy S9, jadi aperture variabel bukanlah hal yang asing pada ponsel, karena telah digunakan oleh banyak merek lain seperti Vivo atau Xiaomi sejak saat itu.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun demikian, kamera dengan bukaan diafragma variabel tentunya akan menjadi mainan menarik bagi departemen kamera ponsel Apple yang dibanggakan, dan dapat menghasilkan permainan cahaya serta bokeh yang menarik dengan bantuan kecerdasan buatan dan fotografi komputasional. 
                                                    </p>
                                                </div>
                                                ...
                                                <Row>
                                                        ...
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/19/645337/mac-mini-m4-dari-apple-dibanderol-mulai-rp9-juta">
                                                                        <img src={other_tekno_1} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/19/645337/mac-mini-m4-dari-apple-dibanderol-mulai-rp9-juta" className="link_deskrip_political">
                                                                                <span>Mac Mini M4 dari Apple, Dibanderol Mulai Rp9 Juta</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/15/644891/amazon-kembangkan-kacamata-gps-untuk-kurir">
                                                                        <img src={other_tekno_2} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/15/644891/amazon-kembangkan-kacamata-gps-untuk-kurir" className="link_deskrip_political">
                                                                                <span>Amazon Kembangkan Kacamata GPS untuk Kurir</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/14/644682/ai-makin-diminati-untuk-bikin-konten">
                                                                        <img src={other_tekno_3} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/14/644682/ai-makin-diminati-untuk-bikin-konten" className="link_deskrip_political">
                                                                                <span>AI Makin Diminati untuk Bikin Konten</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/16/644988/google-rilis-aplikasi-gemini-untuk-ios">
                                                                        <img src={other_tekno_4} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/16/644988/google-rilis-aplikasi-gemini-untuk-ios" className="link_deskrip_political">
                                                                                <span>Google Rilis Aplikasi Gemini untuk iOS
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other_3">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/15/644885/tiga-bulan-cuti-greg-brockman-akhirnya-kembali-ke-openai">
                                                                        <img src={other_tekno_5} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/15/644885/tiga-bulan-cuti-greg-brockman-akhirnya-kembali-ke-openai" className="link_deskrip_political">
                                                                                <span>Tiga Bulan Cuti, Greg Brockman Akhirnya Kembali ke OpenAI
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/tekno/read/2024/11/11/644311/perubahan-besar-apple-akan-gunakan-lensa-aperture-variabel-di-iphone-18">
                                                                        <img src={other_tekno_6} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/tekno/read/2024/11/11/644311/perubahan-besar-apple-akan-gunakan-lensa-aperture-variabel-di-iphone-18" className="link_deskrip_political">
                                                                                <span>Perubahan Besar, Apple akan Gunakan Lensa Aperture Variabel di iPhone 18
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <div className="wadah_content_sidebar_react margin_top_20px">
                                <div className="wadah_react_video_sidebar">
                                    <ReactPlayer width="100%" height="622px" url="https://www.youtube.com/watch?v=ohGfR7F2-No&pp=ygUJdGVrbm9sb2dp" />
                                </div>
                                ...
                                <div className="wadah_video_iklan_top_seven margin_top_iklan_seven background_color_content_berita">
                                    <ReactPlayer width="100%" url="https://www.youtube.com/watch?v=xUpVyEclZuI&pp=ygUJdGVrbm9sb2dp" />
