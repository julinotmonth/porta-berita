                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Media Demokrasi
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                ...
                                                <span className="content_name_reporter content_name_reporter_bold">AHMADIE THAHA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Sabtu, 23 November 2024, 09:07 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_publika_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi pers/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">HELMUT Schmidt, anda pernah kenal dia. Sang negarawan tua Jerman yang juga penerbit Die Zeit ini pernah menulis pengantar untuk buku Constructive News karya Ulrik Haagerup.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Pengantar yang ditulisnya satu dekade lalu itu tampil dengan nada yang hampir menyerupai komedi gelap, namun di tengah itu dia masih optimis menitipkan harapan lebih baik kepada penulis muda seperti Ulrik.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di kata pengantar itu, Schmidt dengan sinis menyebut media modern dan demokrasi hari ini lebih mirip pentas opera sabun ketimbang panggung pemikiran serius. Ia menyebut fenomena ini sebagai media-demokrasi, di mana media menjadi aktor utama dalam drama politik, rajin meninggalkan para politisi sebagai figuran yang hanya sibuk mencari perhatian.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dan, ya, jika Schmidt masih hidup dan pindah ke Indonesia, mungkin ia akan kehabisan tinta untuk mencatat segala absurditas ini. Sebab di sini, media-demokrasi telah berevolusi menjadi demokrasi-clickbait, dengan politisi yang lebih mirip selebritas, kebijakan yang seperti gimik film, dan masyarakat yang lebih sering terpukau oleh berita "tukang kayu masuk gorong-gorong" ketimbang diskusi serius tentang deforestasi, bencana lingkungan, atau reformasi hukum.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Schmidt menyoroti bahwa media-demokrasi "melahirkan bukan pemimpin sejati, tetapi populis." Indonesia tentu menjadi laboratorium sempurna untuk eksperimen ini. Bayangkan seorang tokoh politik bangun tidur, menggulung selimutnya, lalu mencuitkan "Saya Indonesia, NKRI harga mati!" ke Twitter (atau sekarang, X). Lima menit kemudian, berita utama memujinya sebagai suara tokoh nasionalis.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Retorika sensasional ini begitu digemari media. Dari "Jokodok blusukan ke pasar" hingga "berdiri di genangan banjir," semua diliput dengan bumbu narasi pahlawan rakyat. Tapi kebijakan nyata dan implementasi janji kampanye? Tertunda dulu. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebaliknya, mari kita nikmati drama foto-foto viral. Retorika dan gimik inilah opera sabun yang Schmidt maksudkan —dan di Indonesia, acara ini tampaknya berjalan setiap hari dengan rating tinggi. Bahkan mungkin setiap detik.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Schmidt mencibir betapa politik modern telah terjebak dalam keterbatasan media sosial. Di Indonesia, ini mungkin lebih buruk lagi. Alih-alih membangun wacana yang dalam, politisi hingga aparatur negara kita kini berlomba-lomba menjadi "influencer" dadakan, dan pemerintah pun secara resmi membentuk tim buzzer yang dibiayai dengan pajak rakyat. Untuk kepentingan siapa? 
                                                    </p>
                                                </div>
