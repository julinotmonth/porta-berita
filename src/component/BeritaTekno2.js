...
import img_teknoo_2 from "../img/img_teknoo_2.jpg"

function BeritaTekno2 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Tiga Bulan Cuti, Greg Brockman Akhirnya Kembali ke OpenAI
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 15 November 2024, 14:40 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_2} className="content_img_post_berita" />
                                </div>
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Setelah melakukan cuti panjang selama tiga bulan, Greg Brockman, salah satu pendiri OpenAI akhirnya kembali ke perusahaan rintisan kecerdasan buatan tersebut.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kembalinya Brockman ke posisi presiden di OpenAI dibagikan lewat akun X pribadinya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Liburan terpanjang dalam hidupku telah selesai. Kembali membangun @OpenAI," tulisnya, seperti dikutip dari  Reuters, Jumat 15 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Brockman kembali ke OpenAI setelah sejumlah tokoh penting keluar dari perusahaan belum lama ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Mereka yang pergi dari OpenAI adalah mantan Chief Technology Officer Mira Murati, sang pendiri OpenAI John Schulman, dan Ilya Sutskever yang juga pendiri OpenAI. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sutskever dan Murati kini bahkan telah mendirikan perusahaan rintisan AI mereka sendiri.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara Schulman, saat mengumumkan keputusan hengkang dari OpenAI beralasan ia berniat memperdalam fokus pada penyelarasan AI dan terlibat dalam lebih banyak pekerjaan teknis. rmol news logo article
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
