...
import img_nusantara_1 from "../img/img_nusantara_1.jpeg"
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Kemenparekraf Salurkan DPUP agar Desa Wisata Bebas Pinjol
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 20:00 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Penyaluran bantuan Dukungan Pengembangan Usaha Pariwisata (DPUP)/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Bantuan Dukungan Pengembangan Usaha Pariwisata (DPUP) disalurkan kepada 50 desa wisata pemenang Anugerah Desa Wisata Indonesia (ADWI) 2024.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Bantuan tersebut berupa uang Rp120 juta dan pelatihan literasi keuangan dan bisnis. Bantuang uang tersebut dibelanjakan untuk peralatan pendukung produksi usaha pariwisata dan ekonomi kreatif (Parekraf) berupa atraksi wisata, kuliner, kriya, dan fesyen.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Direktur Akses Pembiayaan Kemenparekraf, Anggara Hayun Anujuprana berharap bantuan dan dukungan tersebut dapat dimaksimalkan untuk kepentingan pengembangan parekraf.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami berfokus agar pelaku desa wisata terhindar dari pinjaman online ilegal dan judi online yang sangat meresahkan akhir-akhir ini,” kata Anggara, Jumat, 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Salah satu desa yang menerima bantuan DPUP adalah Desa Hariara Pohan, Kabupaten Samosir. Desa Hariara Pohan memiliki keindahan alam yang sangat bagus lantaran dekat dengan Danau Toba.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Kami berharap desa wisata dapat memacu potensi tumbuhnya ekonomi kreatif di lingkungan setempat serta membuka lapangan pekerjaan bagi warga lokal yang tinggal dekat dengan lokasi wisata,” tambah Ketua Dana Masyarakat Parekraf, Megawati Panjaitan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bantuan juga diberikan dalam rangkaian kegiatan Literasi Keuangan dan Bisnis Kemenparekraf/Baparekraf. Kegiatan ini diikuti 75 orang terdiri dari Pengurus Badan Usaha Milik Desa (BUMDes), perangkat desa, pengelola desa wisata, dan pelaku usaha pariwisata dan ekonomi kreatif. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaNusantara1;