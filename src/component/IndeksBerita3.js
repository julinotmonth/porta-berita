...
function IndeksBerita3 () {
    ...
    const [selectedDate, setSelectedDate] = useState(getCurrentDate());  // State untuk menyimpan tanggal yang dipilih
    const [showCalendar, setShowCalendar] = useState(false);  // State untuk menampilkan/menyembunyikan Calendar

    // Function yang akan dipanggil saat tanggal dipilih di Calendar
    const handleDateChange = (date) => {
        const formattedDate = date.toLocaleDateString('en-CA');
        setSelectedDate(formattedDate);  // Mengupdate state selectedDate
        setShowCalendar(false);  // Menyembunyikan calendar setelah memilih tanggal
    };
    ...
    const totalPages = 3; // Total halaman yang tersedia
                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik_indeks">Indeks Berita RMOL.ID Selasa, 20 Agustus 2024</h1>
                                <div className="wadah_search_tanggal">
                                    <span>Pilih Tanggal:</span>
                                    <div className="wadah_button_tanggal_and_indeks">
                                        <Row>
                                            <Col xl={10} lg={10} md={10} sm={10} xs={8}>
                                                <div className="wadah_button_tanggal">
                                                <input
                                                    value={selectedDate}  // Menggunakan state selectedDate sebagai value
                                                    type="text"
                                                    readOnly
                                                    className="button_tanggal_indeks"
                                                    onClick={() => setShowCalendar(!showCalendar)}
                                                />
                                                <div className="wadah_calendar_libarary">
                                                    {showCalendar && (  // Hanya menampilkan calendar jika showCalendar true
                                            ...
                                            <Col xl={2} lg={2} md={2} sm={2} xs={4}>
                                                <div className="wadah_button_indeks">
                                                    <input type="submit" value="INDEKS" className="content_button_indeks" />
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link>
                                                <img to="/politik/read/1" src={berita_17} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                            ...
                            <Col xl={8} className=" display_none">
                                <div className="wadah_pagination margin_bottom_pagi">
                                    <Link to="/indeksberita/2" className="link_arrow_left margin_right_pagination">
                                        <div className="wadah_arrow_left_pagi"><BiSolidLeftArrow className="arrow_left_pagi" /></div>
                                    </Link>
                                    <Link to="/indeksberita" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">1</div>
                                    </Link>
                                    <Link  to="/indeksberita/2" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">2</div>
                                    </Link>
                                    <Link to="/indeksberita/3" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat">3</div>
                                    </Link>
                                    <Link to="#" className="link_arrow_left">
