                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Penyelundupan Satu Unit Mobil dari Malaysia Berhasil Digagalkan TNI
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Senin, 18 November 2024, 05:51 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Satu unit mobil Toyota Land Cruiser VX 4WD dari Malaysia dan tersangka penyelundupan berhasil diamankan TNI/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Satgas Pamtas Yonarmed 11 Kostrad Pos Tembalang kembali mencatatkan prestasi dengan berhasil menggagalkan upaya penyelundupan satu unit mobil Toyota Land Cruiser VX 4WD dari Malaysia. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Upaya ini dilakukan berdasarkan informasi dari masyarakat yang mencurigai adanya mobil berwarna abu-abu metalik melintas di wilayah Kecamatan Tulin Onsoi dan Kecamatan Sebuku pada Sabtu, 16 November 2024.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dansatgas Yonarmed 11 Kostrad, Letkol Arm Gde Adhy Surya Mahendra menjelaskan kronologi kejadian tersebut. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Personel kami mendapatkan laporan dari masyarakat terkait keberadaan kendaraan yang mencurigakan di wilayah Kecamatan Sebuku. Menindaklanjuti informasi tersebut, kami langsung mengadakan sweeping kendaraan di Pos Tembalang,” jelas Adhi dalam keterangan yang diterima redaksi, Minggu, 17 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam sweeping tersebut, tim Satgas menghentikan dan memeriksa sebuah kendaraan Toyota Land Cruiser VX 4WD dengan pengemudi berinisial RES (39 tahun) dan penumpang YT (39 tahun).  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Setelah dilakukan pemeriksaan menyeluruh, ditemukan adanya ketidaksesuaian antara nomor rangka dan nomor mesin mobil dengan dokumen STNK yang dibawa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dansatgas Pamtas Yonarmed 11 Kostrad menambahkan bahwa keberhasilan ini merupakan bagian dari tugas pokok satuan dalam mengamankan wilayah perbatasan, termasuk mencegah penyelundupan barang ilegal. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Kasus ini adalah bukti nyata bahwa Satgas Pamtas Yonarmed 11 Kostrad selalu siap menjaga kedaulatan dan melindungi perbatasan Indonesia, khususnya di wilayah Kalimantan Utara, dan untuk barang bukti sudah diserahterimakan ke Bea Cukai Nunukan melalui Kepala Bea Cukai Nunukan,” ungkapnya.
                                                    </p>
                                                </div>
...
export default BeritaPertahanan6;