                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Selandia Baru Resmi Cap Hizbullah Organisasi Teror
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 16:33 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_dunia_9} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Tentara Hizbullah/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Di tengah perang yang berkecamuk di perbatasan Lebanon, Selandia Baru menetapkan kelompok militer Hizbullah sebagai organisasi teror.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Perdana Menteri Selandia Baru, Christopher Luxon pada Jumat, 22 November 2024 menyebut keputusan itu diambil karena Hizbullah terbukti melakukan aktivitas teror di Lebanon.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami memiliki bukti, dan kami melalui sejumlah pengujian berdasarkan undang-undang kami, bahwa organisasi tersebut dengan sengaja melakukan aktivitas teroris,” ujarnya, seperti dimuat Anadolu Ajansi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Gerakan perlawanan lain di Timur Tengah seperti Houthi Yaman, dan Ansar Allah juga telah diklasifikasikan sebagai entitas teroris oleh Selandia Baru, menyusul serangan mereka terhadap kapal-kapal yang mendukung Gaza.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Jaringan Solidaritas Palestina, Aotearoa, mengkritik keputusan tersebut, karena baik Hizbullah maupun Houthi melakukan tindakan militer untuk melawan genosida di Gaza.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kelompok ini menuduh pemerintah Selandia Baru menutup mata terhadap kejahatan perang Israel di wilayah tersebut, dan pada saat yang sama mengutuk Perlawanan Palestina.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Hal ini sangat menyakitkan ketika pemerintah Selandia Baru, yang mengutuk setiap tindakan Perlawanan Palestina, menolak untuk mengutuk Israel atas kejahatan perangnya yang mengejutkan di Timur Tengah,” kata kelompok tersebut.rmol news logo article
                                                    </p>
                                                </div>
