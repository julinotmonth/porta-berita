                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ada Aroma Adu Domba di Balik Polemik PSN PIK-2
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 18:48 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Forum Mahasiswa Banten Bersatu (FMBB)/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Ada upaya adu domba dalam polemik Proyek Strategis Nasional (PSN) Pantai Indah Kapuk (PIK-2).</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Pandangan Forum Mahasiswa Banten Bersatu (FMBB), ada pihak-pihak yang mencoba memanfaatkan sentimen ini untuk memecah belah masyarakat Banten.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami menolak keras segala bentuk provokasi yang bertujuan memecah-belah warga Banten oleh sekelompok orang non-Banten. PSN PIK 2 jangan digunakan sebagai alat politik ekonomi yang mengancam harmoni sosial," tegas Ketua FMBB, Fadli Ahmad, Jumat, 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">FMBB mengingatkan, masyarakat perlu mengedepankan pendekatan rasional melihat dampak PSN PIK 2. Dialog terbuka dan inklusif dinilai sebagai solusi terbaik menyelesaikan polemik yang ada.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Kami ingin masyarakat melihat fakta secara objektif dan tidak terjebak dalam narasi adu domba," jelasnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Tokoh masyarakat dan pemuka agama juga didorong turut menjaga persatuan dan stabilitas di Banten. Dengan begitu, upaya adu domba tidak akan sampai mengganggu kerukunan masyarakat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
...
export default BeritaNusantara2;