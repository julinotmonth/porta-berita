                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Hadiri International NGO Fair ke-4, Waketum Hublu MUI Soroti Kaitan Turki Ustmani dan Nusantara
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={hani} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">HANI FATUNNISA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 17:31 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_dunia_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wakil Ketua Komisi Hubungan Luar Negeri Majelis Ulama Indonesia (MUI), Oke Setiadi Affendi di acara International NGO Fair 2024 di Istanbul, Turki pada Kamis waktu setempat, 21 November 2024/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Wakil Ketua Komisi Hubungan Luar Negeri Majelis Ulama Indonesia (MUI), Oke Setiadi Affendi mendapatkan kehormatan untuk memberikan sambutan di pembukaan acara International NGO Fair 2024 di Istanbul, Turki pada Kamis waktu setempat, 21 November 2024. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dalam pidatonya, ia menyoroti hubungan sejarah antara Turki Ustmani dan Nusantara, serta kontribusinya dalam memperkenalkan pentingnya Masjid Al-Aqsa atau Al-Quds di tanah Jawa khususnya Kota Kudus.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dia menjelaskan bahwa  pada masa Turki Ustmani, pengajar dan ulama dikirim ke Nusantara untuk menyebarkan ilmu agama dan semangat perjuangan Islam. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Salah satu dampak nyata dari pengaruh ini terlihat dari penamaan Kota Kudus di Jawa Tengah, yang terinspirasi oleh Al-Quds di Palestina. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bahkan, terdapat Masjid Al-Aqsa di Kudus, mengingatkan kita pada masjid suci di Palestina. Selain itu, Oke juga menyebut Gunung Muria, yang memiliki nama yang identik dengan Bukit Moriah di Palestina. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Sejarah ini menunjukkan betapa pentingnya Masjid Al-Aqsa dalam hati umat Islam di Nusantara, yang diwariskan oleh para ulama dan pengajar yang dikirimkan oleh kekhilafan Turki Ustmani kala itu,” ujarnya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Oke berharap pidatonya dapat menginspirasi, menguatkan persatuan dan melanjutkan perjuangan menjaga masjid Al-Aqsa dan rakyat Palestina untuk mendapatkan hak-haknya sebagai sebuah bangsa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Acara International NGO Fair 2024 ini sendiri menjadi ajang penting bagi organisasi non-pemerintah (NGO) internasional untuk berkumpul, berdiskusi, dan bersinergi dalam rangka membahas isu kemanusiaan di Palestina, dan mendapatkan solusi kongkrit, terutama terkait penjajahan yang sampai saat ini tak kunjung usai.
                                                    </p>
                                                </div>
                                                <div className="wadah_name_editor_org">
                                                    <span className="name_editor_org">EDITOR : </span>
                                                    <span className="name_editor_org bold_editor">HANI FATUNNISA</span>
                                                </div>
                                                <div className="wadah_icon_medsos_politik_1">
                                                    <Link className="link_icon_medsos_politik_1">
                                                        <img src={logo_wa} className="icon_medsos_politik" />
