                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Argentina Tarik Pasukan dari UNIFIL, Indonesia Komitmen Bertahan
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 18:05 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_dunia_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Juru Bicara Kementerian Luar Negeri RI, Roy Soemirat/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Argentina memutuskan menarik pasukannya dari Misi Perdamaian PBB di Lebanon (UNIFIL), di tengah peperangan yang masih berlangsung antara Israel dan Hizbullah di perbatasan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Juru bicara UNIFIL, Andrea Tenenti mengonfirmasi kepergian tiga perwira Argentina dari misi tersebut awal pekan ini. Tetapi dia menolak mengungkap alasan penarikan pasukan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Argentina telah meminta para perwiranya untuk kembali (ke Argentina)," ungkapnya, seperti dikutip dari Reuters pada Jumat, 22 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Merespons hal tersebut, Juru Bicara Kementerian Luar Negeri RI, Roy Soemirat menegaskan bahwa pasukan Indonesia akan tetap mempertahankan pasukannya di UNIFIL. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menurut Roy, keputusan ini sudah sesuai dengan amanat konstitusi, juga mengingat Indonesia merupakan kontributor pasukan terbesar di UNIFIL dengan jumlah sebanyak 1230 personil. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Sampai saat ini, PBB tetap mempertahankan keberadaan pasukan penjaga perdamaian di Lebanon. Pasukan penjaga penjaga perdamaian dari Indonesia tetap melaksanakan tugasnya sesuai arahan Force Commander UNIFIL," kata dia dalam sebuah pernyataan hari Jumat, 22 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Jubir Kemlu itu juga mengungkap bahwa kondisi personel Indonesia dalam keadaan baik, meskipun bulan lalu sempat terdampak serangan udara Israel. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dia menambahkan bahwa pemerintah RI akan terus berkoordinasi memastikan keselamatan dan keamanan seluruh personel mereka di UNIFIL.
                                                    </p>
                                                </div>
