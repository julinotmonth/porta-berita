                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ini Jurus Pemprov DKI Halau Banjir
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 10:52 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Pemprov DKI Jakarta menggelar Apel Kesiapsiagaan hadapi musim hujan/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Berbagai upaya dilakukan Pemprov DKI Jakarta untuk mengantisipasi banjir. Sebab berdasarkan data Badan Meteorologi, Klimatologi, dan Geofisika (BMKG), musim hujan telah masuk pada November 2024 dan puncaknya pada Februari 2025.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Penjabat Gubernur DKI Jakarta Teguh Setyabudi  mengumpulkan berbagai perangkat daerah di lingkungan Pemprov DK dalam apel kesiapsiagaan mengantisipasi musim penghujan di sisi Selatan Monas, Jakarta Pusat, Jumat 22 November 2024
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di depan 1.897 peserta apel, Teguh yang menjadi inspektur upacara mengatakan, apel ini bukti nyata dari komitmen Pemprov DKI Jakarta dalam menghadapi berbagai tantangan yang mungkin terjadi selama musim hujan, khususnya potensi bencana hidrometeorologi. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Dengan kerja keras, kebersamaan, serta partisipasi aktif dari seluruh elemen masyarakat, diharapkan kita dapat menghadapi segala tantangan, meminimalkan risiko banjir dan melewati musim penghujan 2024/2025 dengan aman," kata Teguh.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di samping itu, ia juga menjelaskan pentingnya melakukan berbagai langkah antisipasi dan meneruskan upaya yang telah dilakukan dalam menghadapi musim hujan tahun ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pertama, peningkatan infrastruktur dan teknologi, dengan pembangunan waduk, serta normalisasi beberapa sungai utama dan peningkatan kapasitas pompa sebagai infrastruktur pengendalian banjir telah menunjukkan hasil positif dengan berkurangnya titik-titik banjir. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pembersihan saluran air yang dilakukan secara rutin turut mencegah penyumbatan yang menyebabkan genangan. 
                                                    </p>
                                                </div>
...
export default BeritaNusantara6;