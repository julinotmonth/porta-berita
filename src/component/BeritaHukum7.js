                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">KPK Benarkan Amankan 7 Orang dalam OTT di Bengkulu
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 07:07 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Komisi Pemberantasan Korupsi (KPK)
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Komisi Pemberantasan Korupsi (KPK) membenarkan telah menangkap 7 orang dalam kegiatan tangkap tangan atau operasi tangkap tangan (OTT) yang dilakukan di Provinsi Bengkulu.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Wakil Ketua KPK, Alexander Marwata mengatakan, pihaknya telah melakukan OTT di Bengkulu sejak Sabtu, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ada 7 orang diamankan," kata Alex kepada RMOL, Minggu pagi, 24 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun demikian, Alex mengaku belum mengetahui identitas ketujuh orang yang diamankan tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
