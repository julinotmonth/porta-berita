...
import alfia from "../img/alifia.jpg"
import img_bisnis_5 from "../img/img_bisnis_5.jpeg"

function BeritaBisnis5 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ketegangan di Ukraina-Rusia Bikin Rupiah Ambruk ke Rp15.949
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={alfia} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">ALIFIA DWI RAMANDHITA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 12:00 WIB                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_5} className="content_img_post_berita" />
                                </div>
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Nilai tukar rupiah dibuka ambruk ke 15.949 per Dolar AS pada perdagangan Kamis 21 November 2024.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Mata uang Garuda anjlok 0,48 persen dibandingkan perdagangan sebelumnya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu, mayoritas mata uang Asia dibuka bervariasi pagi ini. Ringgit Malaysia tumbuh 0,03 persen, Peso Filipina turun 0,08 persen, Won Korea Selatan naik 0,08 persen, Dolar Singapura naik 0,04 persen, serta Baht Thailand melonjak 0,16 persen.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Di sisi lain, mayoritas mata uang negara maju dibuka menguat hari ini. Poundsterling Inggris dan Euro Eropa tumbuh 0,04 persen, Franc Swiss serta Dolar Australia melonjak 0,14 persen.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Analis Financial Futures Lukman Leong memprediksi pergerakan Rupiah hari ini tertekan oleh Dolar AS, imbas eskalasi perang di Ukrainan yang membuat mata uang berisiko seperti Rupiah melemah.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ia memperkirakan rupiah akan bergerak di kisaran Rp15.775 sampai Rp15.875 per dolar AS pada hari ini. rmol news logo article
                                                    </p>
                                                </div>
