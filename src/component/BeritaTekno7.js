...
import img_teknoo_7 from "../img/img_teknoo_7.jpeg"


function BeritaTekno7 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">WhatsApp Siapkan Fitur Baru untuk Cek Keaslian Foto dalam Pesan
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 07 November 2024, 15:44 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Fitur baru search on web WhatsApp/GSM Arena
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Platform perpesanan WhatsApp tengah mengembangkan fitur baru yang memungkinkan pengguna melakukan cek keaslian sebuah gambar yang diterimanya.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dikutip dari GSM Arena, Rabu 6 November 2024, fitur ini akan bekerja saat pengguna mengetuk gambar yang terima, di menu tiga titik di kanan atas akan ada entri baru: Cari di web. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Setelah diketuk, gambar tersebut akan diunggah langsung ke Google dan mesin pencari akan menyajikan gambar yang identik dan serupa, sehingga pengguna bisa mendapatkan gambaran yang lebih baik tentang seberapa tepercaya gambar yang diterimanya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dengan pembaruan ini diharapkan memudahkan pengguna untuk memastikan keaslian gambar tanpa membagikannya ke aplikasi Google untuk mencapai tujuan yang sama.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Untuk sementara fitur tersebut hanya tersedia untuk penguji beta, dan mungkin butuh waktu yang lebih lama sebelum tersedia untuk semua pengguna WhatsApp. rmol news logo article 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
