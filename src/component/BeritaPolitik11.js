...
import ridwan from "../img/ridwan.jpg"
import img_politik_11 from "../img/img_politik_11.jpeg"

function BeritaPolitik11 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Sudaryono Minta Pasukan Jangkrik All Out Raih Kemenangan di Kendal</h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={ridwan} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">BONFILIO MAHENDRA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 03:58 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_11} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua DPD Partai Gerindra Jawa Tengah, Sudaryono (tengah)/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Ribuan Pasukan Jangkrik (Jangkau ke seluruh titik) siap untuk merebut kemenangan bagi pasangan Calon Bupati dan Wakil Bupati Kendal, Mirna Annisa dan Urike Hidayat (Riki) pada pilkada 2024.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Ketua DPD Partai Gerindra Jawa Tengah, Sudaryono meminta seluruh pasukan Jangkrik baik pengurus maupun kader partai bekerja keras untuk mencapai hal tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebab menurut Sudaryono, Kendal harus menjadi kemenangan mutlak bagi Partai Gerindra.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Aku sangat berkepentingan, Kendal harus menang, gimanapun caranya, dan saya yakin Kendal menang, surveinya juga sudah bagus, tapi kita tidak boleh lengah, pastikan TPS ini di njenengan,” tegasnya saat menghadiri Konsolidasi Akbar Pilkada Jawa Tengah 2024 bersama jajaran partai Gerindra dan 1.600 lebih pasukan Jangkrik serta saksi Tempat Pemungutan Suara (TPS) di Kabupaten Kendal pada Selasa, 19 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lanjut Sudaryono, dengan kemenangan Mirna dan Riki nantinya bakal memberikan keselarasan dalam pelaksanaan program-program pemerintah pusat dan daerah.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Intinya kita manfaatkan waktu-waktu tinggal sedikit ini untuk kita sosialisasi, kita untuk menggalang suara. Saya minta betul-betul untuk demi kebesaran Gerindra, demi supaya selaras dari pusat sampai daerah ini, sama semua. Maka, Bupatinya harus Gerindra. Dan saya sangat menekankan bahwa Kendal ini wajib hukumnya Mbak Mirna menang. Wajib hukumnya menang," jelasnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Karena njenengan ini adalah mesin partai, maka njenengan-lah yang harus meyakinkan orang-orang sekitar TPS untuk memastikan orang mencoblos Mbak Mirna jadi Bupati Kendal," ungkap Wakil Menteri Pertanian tersebut.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Mirna Annisa sendiri merupakan kader Partai Gerindra, sementara Riki dari Partai Golkar. Keduanya turut didukung oleh PKS, PPP, Partai Nasdem dan Perindo serta tujuh parpol non parlemen.rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPolitik11;