...
import img_politik_12 from "../img/img_politik_12.jpeg"

function BeritaPolitik12 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ujang Komarudin: Jalan Hidup Tak Ada yang Tahu
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={aditya} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 05:58 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_12} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ujang Komarudin/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Kepala Kantor Komunikasi Kepresidenan (Presidential Communication Office/PCO) Hasan Nasbi melantik enam jurubicara (jubir) di Gedung Krida Bhakti, Jakarta, Senin, 18 November 2024 lalu.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Keenam jubir tersebut di antaranya Ujang Komarudin, Philips Vermonte, Adita Irawati, Prita Laura, Dedek Prayudi, dan Hariqo Wibawa Satria.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Hasan juga mengangkat tiga staf khusus, yakni Tjut Andjani, Hafizhul Mizan, dan Syahril Ilhami.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kemudian enam tenaga ahli utama PCO, antara lain Lalu Tubagus Arie Rukmantara, Hamdan Hamedan, Wahyu Andrianto, Albert Tarigan, Pandji Setiadi Nugraha, Ricky Tamba.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ujang Komarudin yang memiliki latar belakang sebagai pengamat politik tidak menyangka dengan jabatan baru ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Direktur Eksekutif Indonesia Political Review (IPR) yang dikenal humble dan dekat dengan wartawan itu mengaku kaget usai mendapat telepon dari seseorang.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Jalan hidup tak ada yang tahu. Saya ditunjuk jadi Juru Bicara Kantor Komunikasi Kepresidenan juga awalnya tidak tahu. Tahu2 saya dihubungi dan diminta hari Senin jam 09.00-12.00 tuk kosongkan waktu,” kata Ujang dikutip RMOL dalam akun Facebook pribadinya, Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selanjutnya, ia sibuk membalas ucapan selamat yang masuk ke Whatsapp dan akun medsos pribadinya hingga malam. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPolitik12;