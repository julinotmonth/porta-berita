...
import bonfilio from "../img/widodo.jpg"
...
import img_pertahanan_1 from "../img/img_pertahanan_1.jpg"
import img_pertahanan_2 from "../img/img_pertahanan_2.jpg"
import img_pertahanan_3 from "../img/img_pertahanan_3.jpg"
import img_pertahanan_4 from "../img/img_pertahanan_4.jpg"
import img_pertahanan_5 from "../img/img_pertahanan_5.jpeg"
import img_pertahanan_6 from "../img/img_pertahanan_6.jpeg"
import img_pertahanan_7 from "../img/img_pertahanan_7.jpg"
import img_pertahanan_8 from "../img/img_pertahanan_8.jpg"
import terkait_pertahanan_1 from "../img/terkait_pertahanan.jpg"
import terkait_pertahanan_2 from "../img/terkait_pertahanan_2.jpeg"
import terkait_pertahanan_3 from "../img/terkait_pertahanan_3.jpeg"
import terkait_pertahanan_4 from "../img/terkait_pertahanan_5.jpg"
import other_pertahanan_1 from "../img/other_pertahanan_1.jpg"
import other_pertahanan_2 from "../img/other_pertahanan_2.jpeg"
import other_pertahanan_3 from "../img/other_pertahanan_3.jpg"
import other_pertahanan_4 from "../img/other_pertahanan_4.jpg"
import other_pertahanan_5 from "../img/other_pertahanan_5.jpeg"
import other_pertahanan_6 from "../img/other_pertahanan_6.jpg"
function BeritaPertahanan8 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                <div className="button_politik">
                                    <Link to="/politik" className="link_button_politik_1">Pertahanan</Link>
                                </div>
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Farewell Pass Kapal Perang Indonesia-Australia Pererat Diplomasi
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Senin, 18 November 2024, 01:35 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">KRI Makassar (MKS)-590 dan KRI RE Martadinata (REM)-331 melaksanakan Farewell Pass dengan dua kapal perang Australia, HMAS Adelaide L01 dan HMAS Stuart 153/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Perairan Indonesia kembali menjadi saksi aksi penuh kehormatan dari TNI Angkatan Laut. Dua kapal perang kebanggaan Indonesia, KRI Makassar (MKS)-590 dan KRI RE Martadinata (REM)-331 melaksanakan Farewell Pass dengan dua kapal perang Australia, HMAS Adelaide L01 dan HMAS Stuart 153. </span>
                                </div>
                                                ...
                                                <Row>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/22/645732/koarmada-iii-hadiri-dialog-kebangsaan-peringatan-23-tahun-otsus-papua">
                                                                <img src={terkait_pertahanan_1} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/pertahanan/read/2024/11/22/645732/koarmada-iii-hadiri-dialog-kebangsaan-peringatan-23-tahun-otsus-papua" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Koarmada III Hadiri Dialog Kebangsaan Peringatan 23 Tahun Otsus Papua</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645694/tni-al-dan-bank-bjb-teken-kerja-sama-perbankan">
                                                                <img src={terkait_pertahanan_2} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/21/645694/tni-al-dan-bank-bjb-teken-kerja-sama-perbankan" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">TNI AL dan bank bjb Teken Kerja Sama Perbankan</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/19/645271/ksal-beberkan-solusi-menghadapi-kompleksitas-ancaman-bangsa">
                                                                <img src={terkait_pertahanan_3} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/pertahanan/read/2024/11/19/645271/ksal-beberkan-solusi-menghadapi-kompleksitas-ancaman-bangsa" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">KSAL Beberkan Solusi Menghadapi Kompleksitas Ancaman Bangsa</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/18/645128/farewell-pass-kapal-perang-indonesia-australia-pererat-diplomasi">
                                                                <img src={terkait_pertahanan_4} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/pertahanan/read/2024/11/18/645128/farewell-pass-kapal-perang-indonesia-australia-pererat-diplomasi" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Farewell Pass Kapal Perang Indonesia-Australia Pererat Diplomasi</span>
                                                        </Link>
                                                    </Col>
                                                </Row>
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kedua kapal perang Australia tersebut sebelumnya berpartisipasi dalam latihan gabungan Keris Woomera 2024 yang sukses mempererat kerja sama militer kedua negara pada Minggu, 17 November 2024.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam suasana yang penuh semangat, KRI MKS-590 dan KRI REM-331 menyampaikan salam perpisahan sebagai tanda bahwa latihan gabungan Keris Woomera 2024 telah selesai dilaksanakan. Manuver kedua kapal perang Indonesia memberikan penghormatan terakhir yang menggugah rasa bangga sekaligus mencerminkan persahabatan antar bangsa. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Tradisi Farewell Pass bukan sekadar formalitas. Di atas gelombang biru Nusantara, momen ini menjadi simbol kehormatan dan solidaritas maritim, sebuah bahasa universal yang dipahami oleh setiap pelaut di dunia. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Gerakan kapal yang selaras, bendera yang berkibar megah, serta suasana hormat yang terasa hingga cakrawala adalah bentuk penghormatan tertinggi kepada rekan sejawat dari negara sahabat. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lebih dari itu, Farewell Pass ini juga menandai babak baru dalam diplomasi maritim Indonesia. TNI AL tidak hanya tampil sebagai penjaga kedaulatan, tetapi juga sebagai duta perdamaian yang mempererat hubungan internasional. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Peristiwa ini mengingatkan bahwa lautan bukanlah sekadar batas wilayah, melainkan jembatan yang menghubungkan bangsa-bangsa dalam semangat kerja sama dan harmoni.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">KRI MKS-590 dan KRI REM-331 telah menunjukkan kepada dunia bahwa tradisi, kehormatan, dan kerja sama adalah nilai-nilai yang selalu dijaga oleh TNI AL di setiap misi yang dijalankan. rmol news logo article
                                                    </p>
                                                </div>
                                                ...
                                                <Row>
                                                        ...
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/20/645431/pelajari-teknologi-drone-irjen-tni-sambangi-industri-pertahanan-afsel">
                                                                        <img src={other_pertahanan_1} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/20/645431/pelajari-teknologi-drone-irjen-tni-sambangi-industri-pertahanan-afsel" className="link_deskrip_political">
                                                                                <span>Pelajari Teknologi Drone, Irjen TNI Sambangi Industri Pertahanan Afsel</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/19/645271/ksal-beberkan-solusi-menghadapi-kompleksitas-ancaman-bangsa">
                                                                        <img src={other_pertahanan_2} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/19/645271/ksal-beberkan-solusi-menghadapi-kompleksitas-ancaman-bangsa" className="link_deskrip_political">
                                                                                <span>KSAL Beberkan Solusi Menghadapi Kompleksitas Ancaman Bangsa</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/18/645132/irjen-tni-tinjau-produksi-hmltv-untuk-satgas-unifil-di-dubai">
                                                                        <img src={other_pertahanan_3} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/18/645132/irjen-tni-tinjau-produksi-hmltv-untuk-satgas-unifil-di-dubai" className="link_deskrip_political">
                                                                                <span>Irjen TNI Tinjau Produksi HMLTV untuk Satgas UNIFIL di Dubai
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/19/645281/indonesia-as-komitmen-tingkatkan-kerja-sama-militer">
                                                                        <img src={other_pertahanan_4} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/19/645281/indonesia-as-komitmen-tingkatkan-kerja-sama-militer" className="link_deskrip_political">
                                                                                <span>Indonesia-AS Komitmen Tingkatkan Kerja Sama Militer</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other_3">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/18/645140/penyelundupan-satu-unit-mobil-dari-malaysia-berhasil-digagalkan-tni">
                                                                        <img src={other_pertahanan_5} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/18/645140/penyelundupan-satu-unit-mobil-dari-malaysia-berhasil-digagalkan-tni" className="link_deskrip_political">
                                                                                <span>Penyelundupan Satu Unit Mobil dari Malaysia Berhasil Digagalkan TNI</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/pertahanan/read/2024/11/18/645128/farewell-pass-kapal-perang-indonesia-australia-pererat-diplomasi">
                                                                        <img src={other_pertahanan_6} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/pertahanan/read/2024/11/18/645128/farewell-pass-kapal-perang-indonesia-australia-pererat-diplomasi" className="link_deskrip_political">
                                                                                <span>Farewell Pass Kapal Perang Indonesia-Australia Pererat Diplomasi
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <div className="wadah_content_sidebar_react margin_top_20px">
                                <div className="wadah_react_video_sidebar">
                                    <ReactPlayer width="100%" height="622px" url="https://www.youtube.com/watch?v=ykEmN-5HBeM&pp=ygUKcGVydGFoYW5hbg%3D%3D" />
                                </div>
                                ...
                                <div className="wadah_video_iklan_top_seven margin_top_iklan_seven background_color_content_berita">
                                    <ReactPlayer width="100%" url="https://www.youtube.com/watch?v=HSSrfT0JN-k&pp=ygUKcGVydGFoYW5hbg%3D%3D" />
...
export default BeritaPertahanan8;