                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Irjen TNI Tinjau Produksi HMLTV untuk Satgas UNIFIL di Dubai
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Senin, 18 November 2024, 02:52 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Irjen TNI Letjen TNI Muhammad Saleh Mustafa mengecek produksi High Mobility Light Tactical Vehicle (HMLTV) di Dubai, UEA/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Inspektur Jenderal (Irjen) TNI, Letjen TNI Muhammad Saleh Mustafa melaksanakan kunjungan kerja ke PT. INKAS di Dubai, Uni Emirat Arab (UEA). </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kegiatan ini merupakan bagian dari rangkaian audit terhadap Atase Pertahanan Republik Indonesia di UEA dan Afrika Selatan, beberapa waktu lalu.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">PT. INKAS, sebagai produsen High Mobility Light Tactical Vehicle (HMLTV), menjadi tujuan kunjungan karena keterlibatannya dalam mendukung kebutuhan kendaraan taktis untuk Satuan Tugas Kontingen Garuda (Satgas Konga) yang bertugas dalam misi perdamaian UNIFIL. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam kesempatan tersebut, rombongan diterima secara resmi oleh CEO PT. INKAS, Mr. Ulugbekhon Maksumov, asal Uzbekistan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pertemuan ini diisi dengan diskusi mengenai berbagai perkembangan terkait kendaraan taktis dan kapal militer dengan spesifikasi panjang 8 hingga 15 meter. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, dilakukan pengecekan terhadap 11 unit HMLTV yang telah dipesan untuk mendukung operasional Satgas Konga UNIFIL. Namun, mengingat situasi yang belum memungkinkan untuk pengiriman ke Lebanon, kendaraan-kendaraan tersebut sementara waktu akan dikembalikan ke Indonesia.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Turut mendampingi dalam kunjungan ini, Irlat Itjen TNI Brigjen TNI Achmad Daeng Leo, Irum Itjen TNI Brigjen TNI Deki Santoso, serta Atase Pertahanan RI untuk UEA Brigjen TNI Muhammad Irawadi beserta staf. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPertahanan7;