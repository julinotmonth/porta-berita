                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bawaslu: Endorse Prabowo untuk Luthfi-Yasin Bukan Pelanggaran
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 18:27 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Bawaslu RI, Rahmat Bagja bersama empat anggota Bawaslu RI/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Keterlibatan Presiden Prabowo Subianto dalam kampanye pasangan calon Gubernur dan Wakil Gubernur Jawa Tengah, Ahmad Luthfi-Taj Yasin bukan pelanggaran kampanye.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Keputusan itu disampaikan Ketua Bawaslu RI, Rahmat Bagja merujuk video endorse Prabowo yang diunggah akun Instagram resmi Ahmad Luthfi.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Pengunggahan video dilakukan 9 November atau pada masa rentang jadwal kampanye pemilihan melalui medsos, yaitu 25 September hingga 24 November 2024, sehingga berdasarkan waktu tidak langgar ketentuan perundang-undangan," ujar Bagja di Kantor Bawaslu, Jalan MH Thamrin, Gondangdia, Menteng, Jakarta Pusat, Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain postingan video kampanye yang tidak melanggar, Bagja juga menjelaskan posisi keterlibatan Prabowo dalam kampanye Luthfi-Yasin di Jawa Tengah. Dimana katanya, berdasarkan UU 10/2016 tentang Pilkada dapat ikut serta dengan ketentuan tertentu. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Secara hukum, presiden dapat ikut kampanye pemilihan berdasarkan pasal 70 ayat 22 UU Pemilihan (Pilkada) juncto Putusan MK 52/2024 dan PP (Peraturan Pemerintah) 32/2018," urainya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Anggota Bawaslu RI dua periode itu menegaskan, Prabowo tidak melanggar UU Pemilu akibat ikut kampanye Luthfi-Yasin lantaran dilakukan di hari libur, sehingga ketentuan cuti juga tidak berlaku. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Namun ketentuan mengenai cuti kampanye yang menjadi syarat untuk ikut serta dalam kampanye tidak berlaku, karena pembuatan video dilakukan pada hari Minggu, 3 November 2024 atau pada hari libur," ungkapnya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Maka dari itu, Bagja kembali menegaskan posisi hukum kejadian Prabowo ikut turun ke pelaksanaan kampanye Luthfi-Yasin, dan tidak menjadi isu liar seperti yang beredar di masyarakat sebelum pengumuman hasil penelusuran Bawaslu RI hari ini. 
                                                    </p>
                                                </div>
