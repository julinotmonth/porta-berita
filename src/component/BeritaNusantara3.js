                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Demo Ikatan Santri DKI Minta PKS Pecat Suswono
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 15:59 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Massa membentangkan spanduk penolakan Suswono di depan Kantor DPD PKS Jakarta/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Pernyataan blunder Suswono terkait narasi janda kaya yang diduga menyinggung Nabi Muhammad SAW masih berbuntut panjang.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kali ini, massa mengatasnamakan Ikatan Santri DKI menggelar demonstrasi di depan Kantor DPD Partai Keadilan Sejahtera (PKS) Jakarta menuntut calon Wakil Gubernur Jakarta itu dipecat dari PKS dan diproses hukum.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam aksinya, massa turut membentangkan beberapa spanduk protes bergambar Suswono yang juga kader PKS.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Pecat Suswono dari kader PKS," demikian bunyi salah satu tulisan dalam spanduk yang dibawa massa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami tidak habis pikir, kenapa orang seperti itu dipilih jadi calon pemimpin. Apa tidak ada lagi yang lain? Ini jelas-jelas menghina Nabi," tegas penasihat Ikatan Santri DKI, Afthon Lubbi, Jumat, 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Afthon menambahkan, pernyataan Suswono tidak hanya melukai umat Islam, tetapi juga merusak citra pemimpin yang seharusnya menjadi panutan masyarakat. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami menuntut agar aparat segera mengadili Suswono. Jangan sampai ucapan Suswono tersebut akan berdampak kegaduhan antar umat beragama," tegasnya. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaNusantara3;