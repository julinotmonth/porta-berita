                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Akhaffu Dhararain
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 07:55 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Saya jawab dengan senyum lebar: “Saya ikut ijtihad para ulama sajalah. Masak iya saya lebih jago dari mereka? Kan enggak. Beberapa ulama dari ormas Islam seperti PUI, Alwashliyah, Hidayatullah, DDII, dan terakhir FPI, serta banyak ulama seperti Prof Din Syamsuddin, menyarankan kita pilih RIDO. Mereka bukan cuma kasih rekomendasi, tapi dengan argumen syar’i yang lengkap. Jadi, lewat pilihan ini, insya Allah lebih bisa saya pertanggungjawabkan di hadapan Allah SWT. Bismillah.”    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ada yang protes, “Tapi Bro, FPI dukung RIDO, bukannya itu kompromi politik dengan Jokowi dan Fufufafa?” Saya langsung pasang ekspresi cool. “Eh, meskipun FPI pilih RIDO, mereka tetap berkomitmen ngejar Jokowi dan antek-anteknya. Terutama kasus Km 50 tuh. Sampai ke ujung dunia katanya. Coba, di mana komprominya? Kalau urusan hukum dan HAM, FPI tetap pegang teguh prinsipnya.”
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Teman itu melanjutkan, “Tapi kan, Ridwan Kamil gabung koalisi yang di dalamnya ada Golkar, PSI, dll?” Saya angkat tangan seperti hakim.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Di belakang RIDO masih ada partai-partai berbasis Islam kok, kayak PKS, PKB, dan PAN. Harapannya mereka bisa jadi pagar betis yang kuat, biar enggak direcoki Mulyono dan kawan-kawannya. Nah, ini kan soal strategi juga.” 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Prinsip akhaffu ad-dhararain adalah salah satu kaidah dalam fikih Islam yang artinya "memilih bahaya yang lebih ringan di antara dua bahaya." Prinsip ini digunakan ketika seorang muslim dihadapkan pada situasi di mana tidak ada pilihan yang sepenuhnya bebas dari risiko atau mudarat.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
