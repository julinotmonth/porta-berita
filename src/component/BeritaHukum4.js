                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ini Fakta Gubernur Bengkulu yang Kena OTT KPK
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 10:51 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Gubernur Bengkulu, Rohidin Mersyah/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Gubernur Bengkulu, Rohidin Mersyah turut dibawa dan diperiksa penyidik Komisi Pemberantasan Korupsi (KPK) saat melakukan operasi tangkap tangan (OTT) sejumlah orang di lingkungan Pemerintah Provinsi (Pemprov) Bengkulu.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Penegasan tersebut disampaikan Kapolresta Bengkulu, Kombes Deddy Nata kepada wartawan, pada Sabtu malam, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ya memang benar Rohidin masuk. Kita tunggu perkembangan lebih lanjut (dari KPK) ya," kata Deddy.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dikutip dari Wikipedia, Rohidin Mersyah lahir di Desa Gelumbang, Kecamatan Manna, Kabupaten Bengkulu Selatan pada tanggal 9 Januari 1970 sebagai anak kelima dari sembilan bersaudara. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Rohidin menyelesaikan pendidikan dasarnya di Kabupaten Bengkulu Selatan, sebelum melanjutkan pendidikan kedokteran hewan di Universitas Gadjah Mada .  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Karier awal Rohidin adalah kepala Pusat Kesehatan Hewan (Puskeswan) Bengkulu Selatan pada 1998.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Jabatan terakhir Eohidin di Pemkab Bengkulu Selatan adalah Kepala Bidang Perencanaan Fisik Prasarana pada 2009.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pasca Ridwan Mukti mengundurkan diri ditahan KPK, Rohidin kemudian ditunjuk sebagai pelaksana tugas (Plt) pada 2017 dan diangkat sebagai gubernur pada 2018 hingga selesai masa jabatannya. 
                                                    </p>
                                                </div>
