                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Wapres Ingatkan Bawaslu Cegah Kejadian Paslon Dibacok di Sampang Terulang
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 12:21 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wakil Presiden Gibran Rakabuming Raka saat menjadi pembina Apel Siaga Pengawasan Masa Tenang Pilkada Serentak 2024 yang digelar Bawaslu RI, di Monas, Gambir, Jakarta Pusat, Rabu pagi, 20 November 2024/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Kejadian pembacokan terhadap salah seorang pendukung pasangan calon kepala daerah di Sampang, Madura, diatensi Wakil Presiden Gibran Rakabuming Raka. Badan Pengawas Pemilihan Umum (Bawaslu) selaku penyelenggara pemilu pun diminta untuk lebih cermat dalam melakukan pencegahan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Gibran menyampaikan imbauannya kepada Bawaslu tersebut ketika menjadi Pembina Apel Siaga Pengawasan Masa Tenang Pemilihan Kepala Daerah (Pilkada) Serentak 2024, di Monumen Nasional (Monas), Gambir, Jakarta Pusat, Rabu, 20 November 2024.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kita tidak ingin apa yang terjadi di Sampang terjadi di tempat lain," ujar Gibran di hadapan 5 pimpinan Bawaslu RI yaitu Rahmat Bagja, Lolly Suhenty, Puadi, Totok Hariyono, dan Herwyn JH Malonda, serta pimpinan Bawaslu Provinsi dan Kabupaten/Kota se-Indonesia di lokasi Apel Siaga. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Gibran menegaskan, Presiden Prabowo Subianto telah menekankan soal pelaksanaan pemilu dan pilkada di Indonesia yang punya kekhasan, sehingga menjadi suatu hal yang mesti diperhatikan lembaga-lembaga penyelenggara pemilu.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Seperti yang Bapak Presiden Prabowo selalu sampaikan, Indonesia ini negara besar, negara yang kaya akan keberagamannya, perbedaan adalah kekuatan kita," tuturnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Jangan sampai karena beda pendapat, karena beda pilihan politik, lalu kemudian kita terpecah, saling hujat, saling baku hantam, apalagi sampai menimbulkan korban jiwa," sambung Gibran.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menurut mantan Walikota Solo itu, perbedaan pilihan hingga perbedaan pendapat itu suatu hal yang lumrah atau wajar. Sehingga seharusnya disikapi secara bijaksana oleh seluruh pihak yang terlibat dalam kontestasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Justru itu yang mewarnai demokrasi kita, justru itu yang mendewasakan demokrasi kita, pemahaman ini yang harus terus disampaikan kepada masyarakat," ucapnya.
                                                    </p>
                                                </div>
