                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Prabowo Diyakini Izinkan Menteri Budi Arie Diperiksa Polisi
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 11:53 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Direktur CBA Uchok Sky Khadafi
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Presiden Prabowo Subianto diharapkan benar-benar mewujudkan komitmennya dalam menciptakan penegakan hukum berkeadilan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Harapan ini disampaikan Direktur Center For Budget Analysis (CBA) Uchok Sky Khadafi menanggapi penanganan kasus judi online oleh kepolisian.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Uchok mendapat informasi Menteri Koperasi Budi Arie Setiadi hingga kini belum diperiksa penyidik Polda Metro Jaya lantaran terkendala izin dari presiden. Padahal sudah ada 24 orang yang telah ditetapkan sebagai tersangka di mana 10 di antaranya anak buah Budi Arie saat menjabat Menkominfo.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Apalagi Pak Prabowo pernah menyebut judi online sebagai salah satu ancaman paling berat di Indonesia sehingga pemberantasannya harus ditopang penegakan hukum yang tidak ragu-ragu. Untuk itu sudah semestinya tidak ragu memberikan izin," kata Uchok kepada RMOL, Minggu, 24 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Penegakan hukum terkait judi online, sebut Uchok yang baru-baru ini bersama pegiat antikorupsi lainnya Iskandar Sitorus mengadukan dugaan hoaks Jaksa Agung Burhanuddin ke Bareskrim Polri, harus dilakukan tidak tebang pilih.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Semua yang terlibat, katanya, harus ditindak tegas termasuk memeriksa Budi Arie sebagai mantan Menkominfo. Dengan begitu masyarakat percaya bahwa hukum tidak hanya tajam ke bawah tetapi juga tajam ke atas.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Pak Prabowo berulang kali menyampaikan penegakan hukum berkeadilan di Indonesia. Inilah saatnya untuk membuktikan," demikian kata Uchok Sky Khadafi.rmol news logo article
                                                    </p>
                                                </div>
