...
import img_bisnis_3 from "../img/img_bisnis_3.jpeg"

function BeritaBisnis3 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bos Kripto Justin Sun Beli Pisang Seharga Rp98,8 Miliar
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 13:01 WIB</span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Pisang karya seniman Italia Maurizio Cattelan/AP
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Sebuah karya seni konseptual buatan seniman Italia Maurizio Cattelan berhasil terjual 6,2 juta Dolar AS (Rp98,8 miliar) dalam sebuah lelang di New York pada Rabu 20 November 2024, waktu setempat.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Uniknya, karya seni yang dinamai "Comedian" ini begitu sederhana dan hanya terdiri dari sebuah pisang yang direkatkan ke dinding dengan lakban. Dan, pria beruntung yang akhirnya membeli karya itu adalah Justin Sun, pendiri platform mata uang kripto TRON.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Karya tersebut mewakili fenomena budaya yang menjembatani dunia seni, meme, dan komunitas mata uang kripto," kata Sun dalam sebuah pernyataan, seperti dikutip dari Associated Press, Kamis 21 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Saat dilelang, karya tersebut menarik perhatian, di mana para hadirin di ruangan yang penuh sesak mengangkat telepon untuk mengambil foto saat dua orang pemandu yang mengenakan sarung tangan putih berdiri di kedua sisi pisang.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Penawaran dimulai pada angka 800.000 Dolar AS dan dalam hitungan menit melonjak hingga 4 juta Dolar AS, dan seterusnya, sebagaimana yang dikatakan oleh juru lelang, Oliver Barker, dengan nada bercanda, "Jangan sampai lolos."
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Barker juga mengompori peserta lelang dengan mengatakan "Jangan lewatkan kesempatan ini."
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kemudian, "Ini adalah kata-kata yang tidak pernah terpikirkan oleh saya akan saya ucapkan: Lima juta Dolar untuk sebuah pisang," ujarnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pisang karya Cattelan menjadi fenomena saat pertama kali dipamerkan pada tahun 2019 di Art Basel Miami Beach. 
                                                    </p>
                                                </div>
