                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Musuh Utama Jokowi itu Ya Habib Rizieq
                                    </h1>
                                </div>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_publika_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Habib Rizieq Shihab/Repro
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">PADA suatu kesempatan setelah keluar penjara beberapa tahun lalu, saya berkesempatan bertemu seseorang di lantai 9 sebuah gedung kawasan Monas.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Orang ini (bapak tua) pada tahun 1998 pernah ditendang Napoleon Bonaparte, di markas militer di Timor Timur. Saat itu, ceritanya, Napoleon yang berpangkat perwira muda, seorang letnan polisi, menjadi penjaga di markas itu.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Karena si bapak tua ini, mirip apek-apek China pedagang, menelepon seseorang sambil selonjoran di ruang teras markas. Napoleon berpikir ini China tua pedagang kurang sopan. Lalu, Napoleon menendang kakinya, menyuruh pergi dari situ, karena mengganggu pimpinan yang sedang rapat di dalam.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sambil lugunya sang bapak tua mohon mohon maaf ke Napoleon dan bilang sebentar selesai. Setelah selesai bapak itu masuk ke dalam ruangan, bukannya meninggalkan gedung militer itu. Sehingga membuat Napoleon marah. Napoleon kemudahan berusaha mengejar ke dalam untuk mengusir. Karena sebagai perwira penjaga dia bertanggung jawab.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Anehnya, ketika Napoleon masuk, orang-orang di dalam semua tertawa terhadap Napoleon. Ternyata bapak tua mirip apek-apek China itu perwira tinggi militer berpangkat Kolonel. Dan Napoleon tersipu keluar ruangan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kembali ke cerita saya menemuinya di lantai 9, silaturahmi sambil menanyakan, "Kenapa Prabowo tidak mau menemui Habib Rizieq selama di Penjara?".
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lalu dia menjawab, "Habib Rizieq adalah musuh utama Jokowi". Selama Jokowi berkuasa tidak mungkin Prabowo bertemu HRS,  katanya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Cerita ini saya sengaja sampaikan ke publik untuk memberikan ingatan kepada rakyat tentang sejarah. Rakyat kita seringkali problem "short (term) memory". Sehingga dengan gampang mendegradasi ketokohan seseorang dalam konteks politik.
                                                    </p>
                                                </div>
