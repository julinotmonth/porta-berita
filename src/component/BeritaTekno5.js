...
import img_teknoo_5 from "../img/img_teknoo_5.jpg"


function BeritaTekno5 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Badai Garam Peretas Tiongkok Akses Data Seluler Jutaan Warga AS
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={jonris} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">JONRIS PURBA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 10 November 2024, 07:16 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_5} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Peretas Tiongkok dilaporkan berhasil mengakses log seluler sensitif pada sejumlah besar warga Amerika setelah menyusup ke dalam sejumlah besar penyedia telekomunikasi AS awal tahun ini. Informasi ini disebutkan disampaikan  dua orang yang terlibat dalam tanggapan terhadap peretasan tersebut.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Seperti diberitakan Politico, kedua orang tersebut mengatakan kelompok peretas yang didukung Tiongkok yang dijuluki Salt Typhoon atau Badai Garam memperoleh akses ke begitu banyak Catatan Detail Panggilan. Catatan tersebut berisi informasi tentang dengan siapa warga Amerika berbicara, seberapa sering, dan kapan, serta data lokasi terperinci yang disediakan oleh layanan jaringan 5G.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Tidak jelas apakah peretas Tiongkok mencuri sebagian dari data tersebut atau seberapa banyak yang dapat mereka curi, kata kedua orang tersebut. Keduanya diberikan anonimitas karena sifat pelanggaran yang sedang berlangsung.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kemungkinan pencurian catatan seluler yang berkaitan dengan jutaan warga Amerika telah menjadi salah satu perhatian utama bagi para penyelidik saat mereka berjuang untuk mengusir Salt Typhoon dari beberapa perusahaan telepon terkemuka di negara itu.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pemerintahan Biden pertama kali mengakui bahwa mereka sedang menyelidiki "akses tidak sah ke infrastruktur telekomunikasi komersial" oleh peretas Tiongkok dua minggu lalu. Namun, sejak saat itu, mereka bungkam soal intrusi siber tersebut, meskipun muncul laporan pers yang menunjukkan bahwa itu adalah salah satu pelanggaran paling serius dalam beberapa tahun terakhir. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Intrusi tersebut pertama kali dilaporkan pada bulan September, tetapi tidak jelas berapa lama Salt Typhoon telah mengintai di dalam jaringan telekomunikasi negara tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dengan menyusup ke dalam setidaknya 10 penyedia telepon utama, termasuk Verizon, AT&T, dan Lumen, Salt Typhoon berhasil menyadap komunikasi yang tidak terenkripsi dari telepon puluhan tokoh politik senior AS, termasuk Presiden terpilih Donald Trump dan pasangannya JD Vance, New York Times melaporkan bulan lalu. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Secara keseluruhan, pihak Tiongkok kemungkinan telah menunjuk ribuan orang untuk pengawasan yang ditargetkan tersebut, Wall Street Journal melaporkan pada hari Selasa. Laporan Journal mengatakan Salt Typhoon "tampaknya memiliki kemampuan" untuk mengakses data hampir semua orang Amerika, tetapi tidak mengonfirmasi bahwa kelompok tersebut telah melakukannya.
                                                    </p>
                                                </div>
                                                <div className="wadah_name_editor_org">
                                                    <span className="name_editor_org">EDITOR : </span>
                                                    <span className="name_editor_org bold_editor">JONRIS PURBA</span>
                                                </div>
                                                <div className="wadah_icon_medsos_politik_1">
                                                    <Link className="link_icon_medsos_politik_1">
                                                        <img src={logo_wa} className="icon_medsos_politik" />
