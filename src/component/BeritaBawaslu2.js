                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bawaslu Instruksikan Jajaran Patroli di Masa Tenang
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Sabtu, 23 November 2024, 10:48 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Bawaslu Rahmat Bagja/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Badan Pengawas Pemilihan Umum (Bawaslu) daerah diinstruksikan melakukan patroli pengawasan selama masa tenang Pilkada Serentak 2024 mulai Minggu, 24 November 2024 besok hingga pencoblosan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">"Jika temukan pelanggaran, segera ambil tindakan. Segera proses dengan undang-undang dan aturan yang berlaku," ujar Ketua Bawaslu RI, Rahmat Bagja, Sabtu, 23 November 2024.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bawaslu daerah diminta patroli untuk menekan terjadinya pelanggaran seperti politik uang atau jual beli suara. Pengawasan melekat terhadap distribusi logistik juga harus dilakukan jajaran adhoc, mulai dari Panitia Pengawas Kecamatan (Panwascam), Pengawas Kelurahan Desa (PKD), dan Pengawas Tempat Pemungutan Suara (PTPS).
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Jajaran Bawaslu harus bisa memastikan distribusi surat suara telah sampai di gudang hingga ke TPS. Agar pemilih bisa menggunakan hak suaranya," imbaunya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Masa tenang Pilkada Serentak 2024 berlangsung selama 3 hari sebelum pencoblosan. Dimulai dari Minggu, 24 November hingga 26 November 2024. Sementara proses pencoblosan berlangsung pada 27 November 2024 secara serentak.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Selama masa tenang Pilkada 2024, kami juga akan menyiapkan petugas piket selama 24 jam untuk menerima laporan terkait dugaan pelanggaran," ujar Zaky, dikutip Kantor Berita RMOLJabar, Sabtu, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bawaslu memastikan pengawas akan turun langsung ke lingkungan Tempat Pemungutan Suara (TPS) untuk memantau situasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pemerintah pusat pun telah menetapkan tanggal 27 November 2024 sebagai hari libur nasional. Hal itu tertuang dalam Keputusan Presiden (Keppres) 33/2024 tentang Hari Pemungutan Suara Pemilihan Gubernur dan Wakil Gubernur, Bupati dan Wakil Bupati, serta Walikota dan Wakil Walikota Tahun 2024 yang diteken Presiden Prabowo Subianto. rmol news logo article
                                                    </p>
                                                </div>
