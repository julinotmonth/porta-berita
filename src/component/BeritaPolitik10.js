...
import img_politik_10 from "../img/img_politik_10.jpeg"
import diki from "../img/diki.jpg"

function BeritaPolitik10 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Cawabup Luwu Timur Foto Bareng Jokowi, Sinyal Dukungan?
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 16:16 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_10} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Calon Wakil Bupati Luwu Timur, Mochamad Akbar Andi Leluasa dan Presiden ke-7 RI, Joko Widodo di SUGBK, Jakarta/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Ada momen menarik di tengah pertandingan kualifikasi Piala Dunia antara Indonesia lawan Arab Saudi di Stadion Utama Gelora Bung Karno (GBK), Jakarta, Selasa, 19 November 2024 kemarin.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Di tribun penonton, tampak Presiden ke-7 RI, Joko Widodo duduk berdampingan dengan Calon Wakil Bupati Luwu Timur, Mochamad Akbar Andi Leluasa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Jokowi tampak mengenakan jersey putih Timnas Sepakbola Indonesia, sementara Akbar kedapatan menggunakan kaus merah putih jersey kontingen Indonesia di Olimpiade Paris 2024.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Potret keduanya ini dimaknai sebagai sinyal dukungan Jokowi kepada cawabup nomor urut 2 itu. Apalagi, keduanya juga berfoto dengan pose salam dua jari.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Saya menilai foto itu adalah bukti Jokowi mendukung Budiman-Akbar. Terlihat Jokowi pun tak canggung saat berfoto bersama, bahkan mengacungkan dua jari,” kata pengamat politik, Arifki Chaniago, Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sinyal dukungan Jokowi ini juga dinilai sejalan dengan partai politik pengusung. Budiman-Akbar didukung Gerindra dan Golkar. Dua partai itu merupakan partai pendukung utama Prabowo-Gibran pada Pilpres 2024.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Budiman-Akbar didukung oleh Gerindra dan Golkar. Calon-calon kepala daerah dari koalisi dua partai itu pasti mendapat dukungan oleh Jokowi,” pungkasnya. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPolitik10;