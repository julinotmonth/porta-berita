                        ...
                        <Row>
                            ...
                            <Col xl={8} className=" display_none">
                                <div className="wadah_pagination margin_bottom_pagi">
                                    <Link to="/hukum/2" className="link_arrow_left margin_right_pagination">
                                        <div className="wadah_arrow_left_pagi"><BiSolidLeftArrow className="arrow_left_pagi" /></div>
                                    </Link>
                                    <Link to="/hukum" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">1</div>
                                    </Link>
                                    <Link to="/hukum/2" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">2</div>
                                    </Link>
                                    <Link to="/hukum/3" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat">3</div>
                                    </Link>
                                    <Link to="/hukum/3" className="link_arrow_left">
