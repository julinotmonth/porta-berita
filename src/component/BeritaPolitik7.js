...
import alfian from "../img/alfian.jpg"
import img_politik_7 from "../img/img_politik_7.jpg"


function BeritaPolitik7 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bahas Program Makan Bergizi Gratis di KTT G20 jadi Bukti Keseriusan Prabowo
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={alfian} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">AHMAD ALFIAN</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 16:59 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Presiden Prabowo Subianto di Konferensi Tingkat Tinggi (KTT) G20 di Brasil/Istimewa
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Presiden Prabowo Subianto membeberkan program makan bergizi gratis untuk para siswa-siswi sekolah dalam Konferensi Tingkat Tinggi (KTT) G20 di Brasil. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dalam forum internasional tersebut, Prabowo menjelaskan bahwa pemerintahannya menempatkan penanggulangan kelaparan dan kemiskinan sebagai prioritas nasional. Bahkan, pemerintahannya juga mengalokasikan anggaran besar untuk pendidikan.</p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menanggapi pernyataan Prabowo, analis komunikasi politik Hendri Satrio alias Hensat mengatakan, ini adalah bentuk ketegasan dan keseriusan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Momen di KTT G20 itu menunjukkan keseriusan Prabowo dalam program Makan Bergizi Gratis itu, posisinya dia tidak ingin dianggap sedang pencitraan, dan memang Prabowo bukan pemimpin artifisial yang saya lihat," kata Hensat lewat keterangan resminya, Rabu 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Founder Lembaga Survei KedaiKOPI itu melanjutkan, keseriusan tersebut juga terlihat dari upaya Prabowo membentuk tim khusus untuk belajar program tersebut dari Brasil. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ini bisa jadi, Prabowo juga ingin mengajak kabinetnya agar serius dalam mengentaskan masalah-masalah seperti kelaparan lewat sikapnya dalam program Makan Bergizi Gratis ini, tinggal kabinetnya saja agar sejalan dengan Pak Presiden," jelas Hensat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain masalah kelaparan dan kemiskinan, dosen Ilmu Politik Universitas Paramadina itu juga mengingatkan Prabowo mengenai persoalan lapangan pekerjaan.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Lapangan kerja, kemiskinan, serta kelaparan ini kan sebenarnya berhubungan, jadi saya harap selain program makan gratis ini Prabowo juga harus memikirkan program untuk menangani sulitnya mencari pekerjaan dan juga fenomena kemiskinan yang semakin berkembang di masyarakat," pungkasnya. rmol news logo article
                                                    </p>
                                                </div>
