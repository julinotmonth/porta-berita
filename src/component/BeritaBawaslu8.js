                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Rawan Pelanggaran, Bawaslu Gelar Simulasi Pengawasan Pencoblosan Pilkada 2024
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Selasa, 19 November 2024, 18:29 WIB</span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Simulasi pengawasan pencoblosan Pilkada Serentak 2024 di tempat pemungutan suara (TPS) yang digelar di Hotel Sultan, Jalan Gatot Subroto, Jakarta Pusat, Selasa, 19 November 2024/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Hari-H pencoblosan Pemilihan Kepala Daerah (Pilkada) Serentak 2024 memiliki sejumlah potensi pelanggaran. Karena itu, Badan Pengawas Pemilihan Umum (Bawaslu) menggelar simulasi pengawasan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Simulasi pengawasan yang dipimpin langsung oleh Ketua Bawaslu RI, Rahmat Bagja, digelar di Hotel Sultan, Jalan Gatot Subroto, Jakarta Pusat, Selasa sore, 19 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Agenda hari ini simulasi pengawasan khusus pemungutan dan penghitungan suara di TPS (tempat pemungutan suara). Kemudian ada tidak kendalanya jika dipraktikkan," ujar Bagja.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dia mengungkapkan, petugas yang akan memelototi jalannya pemungutan dan penghitungan suara di TPS adalah pengawas TPS (PTPS).
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dari indeks kerawanan yang telah dibuat Bawaslu, saat pemungutan dan penghitungan suara di TPS memiliki beberapa potensi kerawanan pelanggaran.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ada beberapa kendala yang sudah ketemu. Misalnya ada perbedaan dalam Undang-undang, ada di form (hasil penghitungan suara) yang berbeda dengan PKPU. Ini satu," papar Bagja.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kemudian kedua, adalah keterlambatan (pembukaan TPS), kemudian juga treatment terhadap pengawas TPS," sambungnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, Bagja juga mendapati kerawanan lain berupa politik uang kepada pemilih, agar bisa mempengaruhi dalam memilih pasangan calon kepala daerah.
                                                    </p>
                                                </div>
