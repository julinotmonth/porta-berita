...
import img_teknoo_3 from "../img/img_teknoo_3.jpg"


function BeritaTekno3 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">AI Makin Diminati untuk Bikin Konten
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 14 November 2024, 02:06 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Penggunaan kecerdasan buatan (AI) dilaporkan terus meningkat/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Minat masyarakat Indonesia terhadap penggunaan kecerdasan buatan (AI) dilaporkan terus meningkat, bahkan telah merambah ke dunia bisnis.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Menurut laporan e-Conomy SEA 2024 yang dirilis oleh Google, Temasek, dan Bain & Company, AI telah menjadi solusi utama bagi masyarakat Indonesia untuk mendukung pertumbuhan bisnis yang berkelanjutan dan inovatif.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“AI sangat penting bahkan telah digunakan untuk mengembangkan bisnis supaya bisa terus berkembang dengan berkelanjutan dan terus berinovasi,"  kata Country Director Google Indonesia Veronica Utami dalam konferensi pers pada Rabu 13 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Nah di Indonesia sendiri AI ini sudah menjadi top of mind untuk masyarakat Indonesia,” sambungnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Berdasarkan laporan tersebut, penggunaan AI yang tinggi di Indonesia tidak hanya terfokus di Jakarta, tetapi juga terlihat di daerah-daerah lain, termasuk Kalimantan Timur dan Kepulauan Riau. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Veronica menambahkan bahwa penerapan AI di Indonesia saat ini mencakup tiga sektor utama, yaitu pemasaran, gaming, dan pendidikan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Aplikasi mobile dengan fitur AI paling populer digunakan untuk pembuatan konten, efek foto, dan pengeditan video," jelasnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Laporan e-Conomy SEA 2024 lebih lanjut menunjukkan sekitar 9 persen masyarakat menggunakan AI untuk pembuatan konten, 9 persen lainnya untuk efek pada foto, 7 persen untuk pengeditan video, sementara sisanya menggunakan AI untuk berbagai keperluan lainnya.rmol news logo article 
                                                    </p>
                                                </div>
