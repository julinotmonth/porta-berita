...
import img_bisnis_2 from "../img/img_bisnis_2.jpeg"

function BeritaBisnis2 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                <div className="button_politik">
                                    <Link to="/politik" className="link_button_politik_1">Bisnis</Link>
                                </div>
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Konglomerat Warren Buffet Borong Saham Domino's Pizza Senilai Rp8,7 Triliun
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={alifia} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">JELITA MAWAR HAPSARI</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 13:14 WIB                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Dewan Komisioner LPS, Purbaya Yudhi Sadewa/LPS

                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Lembaga Penjamin Simpanan (LPS) mencatat sebanyak 137 bank di Indonesia tutup dalam periode 2005 hingga September 2024, atau selama 19 tahun terakhir.</span>
                                </div>
                                                ...
                                                <Row>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645691/bi-guyur-insentif-likuiditas-untuk-perbankan-rp256-5-triliun-pada-oktober-2024">
                                                                <img src={bisnis_terkait_1} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/21/645691/bi-guyur-insentif-likuiditas-untuk-perbankan-rp256-5-triliun-pada-oktober-2024" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Penunjukkan Heru Widodo Dirut ASDP Menuai Kritikan</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645601/penunjukkan-heru-widodo-dirut-asdp-menuai-kritikan">
                                                                <img src={bisnis_terkait_2} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/bisnis/read/2024/11/21/645601/penunjukkan-heru-widodo-dirut-asdp-menuai-kritikan" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Kabar Baik! PMI Bakal Dapat Fasilitas Ini di Bandara Internasional</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/nusantara/read/2024/11/21/645589/kabar-baik-pmi-bakal-dapat-fasilitas-ini-di-bandara-internasional">
                                                                <img src={bisnis_terkait_3} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/nusantara/read/2024/11/21/645589/kabar-baik-pmi-bakal-dapat-fasilitas-ini-di-bandara-internasional" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">Pegadaian Digugat Abai Hak Pegawai</span>
                                                        </Link>
                                                    </Col>
                                                    <Col xl={2} lg={2} md={2} sm={2} xs={3}>
                                                        <div className="wadah_img_berita_terkait_rmol margin_bottom_berita_rmol">
                                                            <Link to="https://rmol.id/hukum/read/2024/11/20/645550/pegadaian-digugat-abai-hak-pegawai">
                                                                <img src={bisnis_terkait_4} className="img_berita_terkait_rmol" />
                                                            </Link>
                                                        </div>
                                                    </Col>
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link to="https://rmol.id/hukum/read/2024/11/20/645550/pegadaian-digugat-abai-hak-pegawai" className="link_span_berita_terkait">
                                                            <span className="span_berita_terkait">RUPS ASDP: Achmad Baidowi Jabat Komut, Heru Widodo Dirut</span>
                                                        </Link>
                                                    </Col>
                                                </Row>
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Sebagian besar dari bank yang tutup ini adalah Bank Perekonomian Rakyat (BPR) dan Bank Perekonomian Rakyat Syariah (BPRS) yang telah selesai menjalani proses likuidasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ketua Dewan Komisioner LPS, Purbaya Yudhi Sadewa, mengungkapkan bahwa angka tersebut mencakup BPR dan BPRS yang ditutup sejak LPS mulai beroperasi pada 2005 hingga 30 September 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Jumlah BPR-BPRS yang telah dilikuidasi adalah 137 bank, yang terdiri dari satu bank umum, 123 BPR, dan 13 BPRS," kata Purbaya dalam Rapat Kerja (Raker) Komisi XI DPR RI, seperti dikutip pada Kamis, 21 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Purbaya menjelaskan bahwa penutupan bank-bank ini tidak terlepas dari masalah manajemen yang buruk. Oleh karena itu, LPS berencana membangun sistem informasi teknologi (IT) yang bisa dimanfaatkan oleh BPR dan BPRS untuk memonitor manajemen mereka. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sistem IT ini, menurut Purbaya, akan mengadopsi teknologi canggih dan akan dikelola serta dipelihara oleh LPS secara gratis agar BPR/BPRS bisa lebih bersaing dengan bank komersial dan fintech.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kita ingin membangun sistem IT untuk BPR/BPRS dan sudah ada anggaran untuk tahun ini guna penilaian visibilitasnya. Tahun depan, kita akan mulai dengan pilot project," tambah Purbaya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada tahun 2024, LPS juga mencatatkan bahwa hingga triwulan III 2024, terdapat 15 BPR-BPRS yang izin usahanya dicabut oleh Otoritas Jasa Keuangan (OJK). Selain itu, 17 BPR-BPRS masih dalam proses likuidasi, termasuk dua bank yang baru ditambahkan dari tahun lalu. 
                                                    </p>
                                                </div>
                                                ...
                                                <Row>
                                                        ...
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645632/salah-satu-orang-terkaya-di-asia-terjerat-kasus-suap-jumbo-didakwa-pengadilan-as">
                                                                        <img src={bisnis_other_1} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645632/salah-satu-orang-terkaya-di-asia-terjerat-kasus-suap-jumbo-didakwa-pengadilan-as" className="link_deskrip_political">
                                                                                <span>Salah Satu Orang Terkaya di Asia Terjerat Kasus Suap Jumbo, Didakwa Pengadilan AS</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645627/bri-kembali-gelar-bazar-umkm-brilian-bantu-berdayakan-dan-perluas-pasar-pelaku-usaha">
                                                                        <img src={bisnis_other_2} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645627/bri-kembali-gelar-bazar-umkm-brilian-bantu-berdayakan-dan-perluas-pasar-pelaku-usaha" className="link_deskrip_political">
                                                                                <span>BRI Kembali Gelar Bazar UMKM BRILiaN, Bantu Berdayakan dan Perluas Pasar Pelaku Usaha</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645621/ini-tiga-kunci-yang-digunakan-kemendag-untuk-kejar-target-ekspor">
                                                                        <img src={bisnis_other_3} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645621/ini-tiga-kunci-yang-digunakan-kemendag-untuk-kejar-target-ekspor" className="link_deskrip_political">
                                                                                <span>Ini Tiga Kunci yang Digunakan Kemendag untuk Kejar Target Ekspor</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left margin_bottom_article_other">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645629/emas-antam-makin-berkilau-tembus-rp1-508-juta-per-gram">
                                                                        <img src={bisnis_other_4} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645629/emas-antam-makin-berkilau-tembus-rp1-508-juta-per-gram" className="link_deskrip_political">
                                                                                <span>Emas Antam Makin Berkilau, Tembus Rp1.508 Juta Per Gram</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article margin_bottom_article_other_3">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645623/kemenperin-akan-inspeksi-pabrik-dan-pasar-untuk-pastikan-kepatuhan-sni">
                                                                        <img src={bisnis_other_5} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645623/kemenperin-akan-inspeksi-pabrik-dan-pasar-untuk-pastikan-kepatuhan-sni" className="link_deskrip_political">
                                                                                <span>Kemenperin akan Inspeksi Pabrik dan Pasar untuk Pastikan Kepatuhan SNI</span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                </Col>
                                                    ...
                                                    <Col xl={6} lg={12} md={12}>
                                                        <div className="padding_other_article_left">
                                                            <Row>
                                                                <Col xl={4} lg={4} md={4} sm={4} xs={4}>
                                                                    <Link to="https://rmol.id/bisnis/read/2024/11/21/645619/pelambatan-ekonomi-china-diperburuk-fdi-yang-anjlok">
                                                                        <img src={bisnis_other_6} className="img_other_articles" />
                                                                    </Link>
                                                                </Col>
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link to="https://rmol.id/bisnis/read/2024/11/21/645619/pelambatan-ekonomi-china-diperburuk-fdi-yang-anjlok" className="link_deskrip_political">
                                                                                <span>Pelambatan Ekonomi China Diperburuk FDI yang Anjlok
                                                                                </span>
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <div className="wadah_content_sidebar_react margin_top_20px">
                                <div className="wadah_react_video_sidebar">
                                    <ReactPlayer width="100%" height="622px" url="https://www.youtube.com/watch?v=_BNU-31nLfk&t=546s&pp=ygUGYmlzbmlz" />
                                </div>
                                ...
                                <div className="wadah_video_iklan_top_seven margin_top_iklan_seven background_color_content_berita">
                                    <ReactPlayer width="100%" url="https://www.youtube.com/watch?v=9j76n7C7TmI&t=195s&pp=ygUHZmluYW5jZQ%3D%3D" />
