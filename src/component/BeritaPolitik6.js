...
import img_politik_6 from "../img/img_politik_6.jpg"

function BeritaPolitik6 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">BNPB Pastikan Stok Makanan untuk Korban Erupsi Gunung Lewotobi Laki-laki Aman
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 17:20 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Kepala Badan Nasional Penanggulangan Bencana (BNPB), Letjen TNI Suharyanto, saat memberikan keterangan kepada awak media di Jakarta, Rabu, 20 November 2024/Net
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Badan Nasional Penanggulangan Bencana (BNPB) memastikan stok makanan untuk warga yang mengungsi akibat erupsi Gunung Lewotobi Laki-laki di Desa Klatanlo, Wulanggitang, Kabupaten Flores Timur, Nusa Tenggara Timur (NTT) aman hingga 2 minggu ke depan.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kepala BNPB, Letjen TNI Suharyanto mengatakan, jumlah pengungsi hingga saat ini semakin berkurang. Bahkan, secara berangsur-angsur warga sudah mengungsi ke tempat saudara atau kerabat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Dan yang mengungsi di rumah saudara dan kerabatnya pemerintah tidak lepas, tetap dikasih namanya dana tunggu hunian, Rp500 ribu kali 6 bulan," kata Suharyanto didampingi Menteri Sosial Saifullah Yusuf alias Gus Ipul kepada wartawan di Graha BNPB, Jakarta Timur, Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Suharyanto menjelaskan, pemerintah melalui Kementerian Sosial (Kemensos) juga telah memberikan bantuan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Dan kami pastikan sampai hari ini untuk makan minum terjamin. Bahkan stoknya sampai dua minggu ke depan masih terpenuhi," terang Suharyanto.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Suharyanto menambahkan, BNPB dan Kemensos telah bersepakat bahwa pemerintah akan memberikan bantuan setelah 1 bulan kemudian. Mengingat, saat ini masih banyak bantuan yang berdatangan dari masyarakat.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Nah kami sepakat BNPB dengan Kemensos, kita akan memberikan bantuan nanti setelah sebulan ke depan. Karena biasanya di tempat-tempat bencana yang lain, setelah sebulan itu sudah tidak ada lagi bantuan dari nonpemerintah. Sehingga tentu saja masyarakat mengharapkan bantuan pemerintah. Istilah kami itu kita main panjang," pungkasnya. rmol news logo article
                                                    </p>
                                                </div>
