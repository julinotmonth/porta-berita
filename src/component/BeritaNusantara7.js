                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Pemuda Pelopor Pendidikan Ajak Anak Muda Indonesia Mahir dalam Berkomunikasi
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 10:42 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Pemuda Pelopor Pendidikan dan CEO Talkactive, Ferik Trianda/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Khazanah komunikasi memiliki lingkup yang sangat luas, terutama sejak berkembangnya platform digital.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Pemuda Pelopor Pendidikan dan CEO Talkactive, Ferik Trianda, mengatakan, generasi Z memiliki potensi yang luas dalam mengembangkan skill apa pun dalam khazanah komunikasi ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Bagi saya semua orang termasuk anak muda apalagi Gen Z, memiliki kemampuan komunikasi yang mumpuni. Hanya saja terkadang masih merasa malu, dan tidak percaya diri" ujar Ferik, dalam keterangannya di Jakarta,  dikutip Jumat 22 November 2024.\
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ferik menjelaskan bahwa komunikasi bukan sekedar kemampuan dalam berbicara baik secara lingkup kecil maupun di hadapan banyak audiens saja, namun komunikator ini harus mampu menjadi pendengar yang baik.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Oleh karena itu, melalui Talkactive, ia berkomitmen untuk mengobarkan semangat tersebut agar Sumber Daya Manusia khususnya anak muda di Indonesia mahir dalam berkomunikasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Komunikasi menjadi kunci bagaimana kita berinteraksi, dan mendapatkan kepercayaan dari semua pihak. Semangat inilah yang terus ingin kita sebarkan ke semua daerah di Indonesia. Ini supaya anak muda di Indonesia dilirik oleh dunia, lewat kemampuan komunikasi yang mereka punya," ujar Ferik.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Talkactive telah mengobarkan semangat tersebut kepada lebih dari 10.000 peserta dan dipercaya oleh klien besar seperti: Pelindo, Krakatau Bandar Samudera, Bank Indonesia, KPK, Bank Sinarmas, Kemenkeu, dan lainnya.
                                                    </p>
                                                </div>
...
export default BeritaNusantara7;