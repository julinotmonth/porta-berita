                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik">Politik</h1>
                            ...
                            <Col xl={8} className=" display_none">
                                <div className="wadah_pagination margin_bottom_pagi">
                                    <Link to="/politik/2" className="link_arrow_left margin_right_pagination">
                                        <div className="wadah_arrow_left_pagi"><BiSolidLeftArrow className="arrow_left_pagi" /></div>
                                    </Link>
                                    <Link to="/politik" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">1</div>
                                    </Link>
                                    <Link to="/politik/2" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat_non">2</div>
                                    </Link>
                                    <Link to="/politik/3" className="link_angka_paginat margin_right_pagination">
                                        <div className="wadah_angka_paginat">3</div>
                                    </Link>
                                    <Link to="/politik/3" className="link_arrow_left">
