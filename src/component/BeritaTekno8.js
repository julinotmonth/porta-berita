...
import img_teknoo_8 from "../img/img_teknoo_8.jpeg"


function BeritaTekno8 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Infinix Zero 40 5G Dirilis, Lebih Kencang dengan Chipset Dimensity 8200 Ultimate
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 07 November 2024, 09:32 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Infinix Zero 40 5G/GSM Arena
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Infinix kembali merilis ponsel kelas atas terbaru mereka, Zero 40 5G. Hadir dengan desain yang lebih mewah, ponsel ini membawa berbagai peningkatan yang cukup signifikan dari pendahulunya, Zero 30.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dikutip dari GSM Arena, Rabu 7 November 2024, Infinix Zero 40 5G dibekali panel AMOLED berukuran 6,78 inci dengan kecepatan refresh 144Hz. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sistem kameranya dilengkapi sensor utama 108MP di bagian belakang dengan sensor kedalaman 2MP dan unit 50MP di bagian depan. Ponsel ini juga sudah ditanami kamera ultrawide 50MP dengan autofokus yang juga dapat digunakan untuk bidikan makro.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Perbedaan terbesar dari pendahulunya terletak pada chipset, di mana Zero 40 5G ditanami Mediatek Dimensity 8200 Ultimate yang pastinya lebih cepat dari Dimensity 8020 pada Zero 30.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Soal ketahanan, Infinix Zero 40 5G sudah bersertifikat IP54 yang ditingkatkan, speaker yang disetel oleh JBL, dan, tentunya desain yang lebih segar.rmol news logo article 
                                                    </p>
                                                </div>
