...
import img_politik_8 from "../img/img_politik_8.jpg"

function BeritaPolitik8 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Korban Meninggal Erupsi Lewotobi Laki-laki Dapat Santunan Rp15 Juta
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 16:46 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Pemerintah telah memberikan santunan berupa uang senilai Rp15 juta kepada ahli waris setiap orang yang meninggal dunia akibat erupsi Gunung Lewotobi Laki-laki di Desa Klatanlo, Wulanggitang, Kabupaten Flores Timur, Nusa Tenggara Timur (NTT).
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Hal itu disampaikan langsung Menteri Sosial (Mensos), Saifullah Yusuf alias Gus Ipul, usai menyambangi dan bertemu dengan Kepala Badan Nasional Penanggulangan Bencana (BNPB), Letjen TNI Suharyanto di Graha BNPB, Jakarta Timur, Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kepada yang meninggal semua sudah diserahkan ke ahli waris, ada sembilan orang itu Rp15 juta. Setiap korban yang meninggal Rp15 juta," kata Mensos Gus Ipul.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu, lanjut Gus Ipul, terhadap korban luka-luka akibat erupsi juga diberikan santunan uang sebesar Rp5 juta.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ada luka berat atau luka ringan itu sebenarnya sama. Tapi yang lain itu berupa bantuan sosial," pungkas Gus Ipul. rmol news logo article
                                                    </p>
                                                </div>
