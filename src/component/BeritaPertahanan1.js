                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Perwira TNI AL Raih Predikat Outstanding dalam Kursus Long ASW di India
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 02:59 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Lettu Laut (P) Yudha Batara Pulungan/Puspen TNI
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Prestasi membanggakan diraih Perwira TNI AL Lettu Laut (P) Yudha Batara Pulungan di luar negeri.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Ia berhasil lulus dengan Predikat Outstanding dalam Long ASW Course 2024 yang digelar di Kochi, India, Minggu, beberapa waktu lalu.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Berdasarkan info yang diperoleh redaksi, Sabtu, 23 November 2024, predikat  Outstanding ini diraih Lettu Laut (P) Yudha Batara Pulungan karena mendapatkan nilai akumulatif keseluruhan di atas 8, dengan sistem penilaian ujian tertulis, ujian praktek pada setiap pelajaran serta Tugas Akhir Sekolah. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lettu Yudha berhasil lulus dengan nilai rata-rata akhir 81.42 persen.  Long ASW Course 2024 merupakan kursus yang setara dengan Dikspespa TNI AL. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kurus ini selama 7 bulan sejak tanggal 15 April sampai dengan 14 November 2024 yang diikuti 16 peserta dari berbagai negara yaitu Indonesia, Malaysia, Myanmar, Sri Lanka, Bangladesh, Tanzania, Namibia, Timor Leste dan Brazil. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selama pelaksanaan kursus, seluruh peserta diberikan pemahaman bagaimana menjadi seorang Perwira yang mempunyai kemampuan spesialisasi Peperangan Anti Kapal Selam secara profesional dan andal dalam segi profesi, taktik dan kedaruratan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
...
export default BeritaPertahanan1;