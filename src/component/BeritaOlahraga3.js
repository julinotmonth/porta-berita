                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Lolos ke Perempat Final China Masters 2024, Jonatan Christie Tak Peduli Soal World Tour Finals
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 17:47 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_3} className="content_img_post_berita" />
                                </div>
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Performa tak kalah apik ditunjukkan tunggal putra Indonesia, Jonathan Christie di babak 16 besar China Masters 2024, Kamis, 21 November 2024. Wakil tuan rumah, Lu Guang Zu, disingkirkan dalam dua gim langsung, 21-8 dan 21-19.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Jonatan Christie lakukan aksi tancap gas sejak awal gim pertama. Jojo, sapaan akrabnya, bahkan mampu unggul 9-1 untuk menutup interval dengan keunggulan jauh, 11-3.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selanjutnya, Jojo terus pegang kendali. Hingga menutup gim pertama dengan skor 21-8.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada gim kedua, Lu Guang Zu mencoba bangkit. Dia berupaya menempel perolehan angka Joko. Tapi Jojo enggan memberi angin, dan unggul saat interval dengan 11-9.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Usai interval, Lu Guang Zu sempat menyamakan poin 12-12. Beruntung, Jojo masih bisa menjauh lagi 15-12. Jojo akhirnya bisa memenangi gim kedua 21-19. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Usai laga, Jojo pun bersyukur bisa membalas dua kekalahan sebelumnya dari Lu Guang Zu. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Tapi cukup kaget dengan perubahan shuttlecock dibandingkan pertandingan pertama hari Selasa lalu, hari ini lajunya lebih kencang. Beruntung dari strategi dan penyesuaian tadi bisa masuk polanya, bagaimana untuk mempercepat tempo yang membuat dia tidak nyaman dan akhirnya banyak pengembalian yang keluar," ujarnya, melalui keterangan PBSI, Kamis, 21 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kembali lagi, saya tidak mau terlalu terpengaruh kondisi apakah akan main di World Tour Finals atau tidak. Peluang masih ada, tapi saya jalani saja," tandasnya. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaOlahraga3;