...
import indra from "../img/ridwan.jpg"
import POLITIK2 from "../img/POLITIK2.jpeg";
import img_politik_2 from "../img/img_politik_2.jpg"

function BeritaPolitik2 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ini Alasan Golkar Belum Resmi Umumkan Ridwan Kamil untuk Pilkada Jakarta</h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={indra} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 08 Agustus 2024, 21:45 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wakil Ketua Umum Partai Golkar Ahmad Doli Kurnia di kantor DPP Partai Golkar, Palmerah, Jakarta Barat, Kamis (8/8)./Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Politisi Golkar sekaligus mantan Gubernur Jawa Barat Ridwan Kamil bakal diploting maju di Pilkada Jakarta. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Sayangnya, Wakil Ketua Umum (Waketum) Partai Golkar, Ahmad Doli Kurnia mengatakan mereka secara resmi mendeklarasikan Ridwan Kamil. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami belum mengumumkannya secara resmi karena tinggal tahap akhir saja karena daerah strategis ini nanti akan kami umumkan bersama pasangannya termasuk nanti juga di Jawa Barat," kata Ahmad Doli di Kantor DPP Partai Golkar, Palmerah, Jakarta Barat, Kamis (8/8). 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Nantinya, nama-nama calon yang akan maju di Jakarta dan dan Jawa Barat akan disampaikan langsung oleh para pimpinan parpol Koalisi Indonesia Maju (KIM). 
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Sekarang dalam proses akhir ya, mudah-mudahan satu dua hari ini sudah tuntas. Sudah sampai nanti ke level para ketua umum ya, Pak Airlangga dengan Pak Prabowo, Pak Zulhas, Pak AHY dan dengan yang lain-lain di Koalisi Indonesia Maju bersama juga kalau misalnya proposal kami diterima, diterima oleh partai-partai politik yang lain," kata Doli.rmol news logo article
                                                    </p>
                                                </div>
