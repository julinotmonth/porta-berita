...
import img_bisnis_6 from "../img/img_bisnis_6.jpeg"

function BeritaBisnis6 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Biang Kerok Kerugian Bank-bank di Wall Street Ini Dihukum 18 Tahun Penjara
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 11:37 WIB                                               </span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_6} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Bill Hwang/BBC
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Pengadilan Manhattan AS menjatuhkan hukuman 18 tahun penjara kepada mantan investor miliarder Sung Kook "Bill" Hwang dalam kasus skandal Archegos Capital Management.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Kasus tersebut mengakibatkan kerugian bagi bank-bank Wall Street lebih dari 10 miliar Dolar AS (Rp159 triliun). 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Hwang dijatuhi hukuman oleh Hakim Distrik AS, Alvin Hellerstein, di Manhattan dalam sidang yang digelar Rabu 20 November 2024, di mana juri memutuskan dirinya bersalah pada bulan Juli atas 10 tuduhan pidana termasuk penipuan melalui kabel atau wire fraud, penipuan sekuritas, dan manipulasi pasar.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Jumlah kerugian yang disebabkan oleh tindakan Anda lebih besar daripada kerugian lain yang pernah saya alami," kata Hellerstein sebelum mengumumkan hukuman, seperti dikutip dari Reuters, Kamis 21 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Archegos merupakan kantor keluarga yang dibentuk untuk mengelola uang milik orang kaya dengan aturan yang lebih fleksibel daripada dititipkan ke manajer hedge fund. Archegos sendiri mengelola uang pribadi milik Bill Hwang.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Keruntuhan Archegos pada Maret 2021 terjadi dalam waktu kurang dari seminggu, mengejutkan Wall Street dan para pemberi pinjaman Hwang. 
                                                    </p>
                                                </div>
