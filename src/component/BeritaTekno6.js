...
import img_teknoo_6 from "../img/img_teknoo_6.jpeg"


function BeritaTekno6 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Google akan Rilis Android 16 untuk TV pada 2026
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Sabtu, 09 November 2024, 13:59 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_6} className="content_img_post_berita" />
                                </div>
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Google mengumumkan kehadiran update baru untuk Android TV. Jadwal perilisan tersebut akan mengalami perubahan menjadi per dua kali dalam satu tahun. 
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Namun, Google akan melewati perilisan Android TV 15  dan melompat luncurkan Android TV 16 paa tahun 2026 mendatang.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dikutip dari GSM Arena, Sabtu 8 November 2024, alasan utama Google mengurangi pembaruan OS untuk TV adalah karena pelanggan tidak memperbarui TV mereka sesering yang mereka lakukan pada ponsel pintar. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pelanggan biasanya memperbarui TV selama 5 hingga 10 tahun dan mendasarkan pilihan mereka pada faktor lain seperti harga, ukuran layar, dan spesifikasi perangkat keras, bukan pembaruan perangkat lunak.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Untuk itu, Google tidak perlu secara rutin merilis update sistem operasi setiap tahun. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
