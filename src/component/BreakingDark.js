...
function BreakingDark () {
    ...
    return (
        <div className="background_breakingdark">
                    ...
                    <Row>
                        <Col xl={9} lg={9} md={9}>
                            <div className="wadah_content_breaking_2">
                                <Row>
                                    <Col xl={3} lg={3} md={3}>
                                        <div className="button_breaking_news">Breaking News:</div>
                                    </Col>
                                    <Col xl={9} lg={9} md={9}>
                                        <Slider {...settings}>
                                            <div className="breaking-news-item">               
                                                <Link to="#" className="link_breaking_news color_link_breaking_news">
                        ...
                        <Col xl={3} lg={3} md={3}>
                            <p className="date_now color_date_now">Selasa, 06 Agustus 2024</p>
                            <div className="wadah_icon_medsos">
                                <Link to="#" className="icon_medos_dark">
                                    <IoLogoFacebook />
                                </Link>
                                <Link to="#" className="icon_medos_dark">
