                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Koarmada III Hadiri Dialog Kebangsaan Peringatan 23 Tahun Otsus Papua
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 02:36 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">acara Dialog Kebangsaan dengan tema "Merajut Kesatuan, Implementasikan Asta cita, Wujudkan Papua yang Mandiri, Adil dan Sejahtera" Bertempat di Gedung Jamroni Universitas Pendidikan Muhammadiyah (Unimuda) Sorong, Kamis, 21 November 2024/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Kapok Sahli Koarmada III Laksamana Pertama TNI Ridwan Prawira, mewakili Panglima Komando Armada III (Pangkoarmada III) Laksamana Muda TNI Hersan, menghadiri acara Dialog Kebangsaan dengan tema "Merajut Kesatuan, Implementasikan Asta cita, Wujudkan Papua yang Mandiri, Adil dan Sejahtera" Bertempat di Gedung Jamroni Universitas Pendidikan Muhammadiyah (Unimuda) Sorong, Kamis, 21 November 2024.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Acara dipimpin oleh Dr. Drs Mohammad Musa'ad,M.Si (Pj Gubernur Papua Barat Daya ) dan di Hadiri Dr. Ribka Haluk (Wamendagri).    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada sambutannya  Pj. Gubernur Papua Barat Daya Dr. Drs Mohammad Musa'ad menyampaikan untuk bersama-sama melakukan refleksi perjalanan 23 tahun lahirnya Undang-Undang Otonomi Khusus bagi Provinsi Papua. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Undang-Undang ini, yang dirumuskan dan disahkan pada 1 Januari 2002, melalui proses panjang yang melibatkan berbagai pihak, termasuk Presiden Megawati Soekarnoputri dan Wakil Presiden Hamzah Haz, yang menjadi tonggak penting dalam pembangunan dan kemajuan Papua" ungkap Pj.Gubernur.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lanjut Dr Mohammad Musa'ad, wilayah Papua yang awalnya terdiri dari dua provinsi kini berkembang menjadi enam, yaitu Papua, Papua Barat, Papua Selatan, Papua Tengah, Papua Pegunungan, dan Papua Barat Daya, sebagai upaya mendekatkan per layanan kepada masyarakat dan mempercepat pemerataan pembangunan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Visi besar kita adalah mewujudkan Papua yang mandiri, adil, cerdas, dan bebas korupsi, dengan semangat persatuan yang didasarkan pada kekayaan budaya, adat, serta potensi alam Papua yang luar biasa dalam bingkai Negara Kesatuan Republik Indonesia, kita harus terus bersatu dan bekerja sama untuk mewujudkan Papua yang lebih maju, sejahtera, dan bermartabat," jelas Pj.Gubernur. rmol news logo article
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Prestasi gemilang yang diraih oleh Perwira TNI AL ini selaras dengan penekanan Kepala Staf Angkatan Laut (KSAL) Laksamana TNI Dr. Muhammad Ali untuk membangun SDM TNI AL yang unggul dan profesional dengan mendorong personelnya terutama jajaran perwira untuk mengembangkan diri dengan melanjutkan pendidikan ke jenjang yang lebih tinggi baik di dalam maupun di luar negeri. rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPertahanan2;