...
import yudis from "../img/yudis.jpg"


function BeritaNusantara5 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Anggota DPRD Labura Ahmad Fauzi Gelar Roadshow Program Jumat Berkah
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={yudis} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">YUDHISTIRA WICAKSONO</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 13:10 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_5} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Roadshow Jumat Berkah di Kabupaten Labuhanbatu Utara/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Anggota DPRD Kabupaten Labuhanbatu Utara (Labura) dari Fraksi PAN, Ahmad Fauzi Syahputra, terus menggelar Roadshow Jumat Berkah di daerah pemilihannya (Dapil). </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Program berbagi makanan dan minuman bada salat Jumat ini sudah berjalan di empat desa sejak ia dilantik pada 25 September 2024 lalu.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ahmad Fauzi mengatakan bahwa program ini bertujuan untuk berbagi berkah dengan masyarakat setempat melalui kunjungan dari masjid ke masjid di Dapil Labura 3, yang mencakup dua kecamatan, yakni Aek Kuo dan Marbau.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Ahamdulillah, program Roadshow Jumat Berkah ini terus berjalan. Di Dapil saya, ada 8 desa di Kecamatan Aek Kuo dan 17 desa serta 1 kelurahan di Kecamatan Marbau. Insya Allah, semua desa akan merasakan program ini,” ujar Fauzi dalam keterangannya, Jumat 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Fauzi yang juga Ketua Fraksi PAN DPRD Labura ini menegaskan bahwa program tersebut murni sebagai bentuk rasa syukur setelah dirinya dipercaya menjadi wakil rakyat di Labura. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Sejak awal, niat kami hanya untuk berbagi tanpa ada muatan politik. Ini adalah bentuk rasa syukur kami setelah terpilih sebagai anggota DPRD. Mohon doa agar kami istiqomah,” kata Fauzi. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ketua Dewan Pimpinan Pusat (DPP) Ikatan Mahasiswa Muhammadiyah (IMM) 2016-2018 ini juga meminta doa kepada masyarakat agar program tersebut dapat terus berjalan selama masa jabatannya. 
                                                    </p>
                                                </div>
...
export default BeritaNusantara5;