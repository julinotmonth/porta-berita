                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">PDIP Dikabarkan Usung Anies di Pilkada Jabar, Begini Respons Puan</h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Thursday, August 29, 2024, 12:56 WIB</span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={content_berita_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Chairwoman of the PDIP Central Executive Board Puan Maharani/RMOL</span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Setelah berpeluang besar gagal maju di Pilkada Jakarta 2024, santer beredar kabar bahwa Anies Baswedan bakal diusung PDIP di Pilkada Jawa Barat (Jabar) 2024.</span>
                                </div>
                                            ...
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <Row>
                                                    ...
                                                    <Col xl={10} lg={10} md={10} sm={10} xs={9}>
                                                        <Link className="link_span_berita_terkait">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Saat dikonfirmasi, Ketua DPP PDIP, Puan Maharani, enggan berspekulasi soal kebenaran kabar tersebut. Dia hanya mengatakan bahwa masih ada waktu pendaftaran calon kepala daerah hingga hari ini, Kamis (29/8), pukul 23.59 WIB.</p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kita lihat sampai nanti sore kan waktu pendaftarannya masih sampai sore," kata Puan kepada wartawan di Komplek Parlemen, Senayan, Jakarta, pada Kamis (29/8). </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebelumnya, beredar isu Anies Baswedan akan dipasangkan dengan Ketua DPD PDIP Jawa Barat Ono Surono di Pilkada Jabar.</p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Isu ini mencuat karena hingga kini PDIP masih terus menggodok pasangan calon untuk diusung di Pilgub Jabar 2024.</p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, akhirnya PDIP memutuskan mengusung Pramono Anung dan Rano Karno di Pilkada Jakarta 2024.</p>
                                                </div>
                                                                ...
                                                                <Col xl={8} lg={8} md={8} sm={8} xs={8}>
                                                                    <div className="wadah_political_and_deskrip_article padding_right_article">
                                                                        ...
                                                                        <div className="wadah_deskrip_political">
                                                                            <Link className="link_deskrip_political">
                        ...
                        <Col xl={4} lg={4} md={12} sm={12}>
                            <div className="wadah_content_sidebar_react margin_top_20px">
                                <div className="wadah_react_video_sidebar">
                                    <ReactPlayer width="100%" height="622px" url="https://www.youtube.com/watch?v=HqDxFgBP36c" />
                                </div>
