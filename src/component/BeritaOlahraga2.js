                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Juara Umum IESF 2024 di Riyadh, Indonesia Kokohkan Posisi Superpower Esports Dunia
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 20:35 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Timnas Indonesia Esport/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Tim Nasional Indonesia menjadi juara umum pada ajang 16th IESF World Esports Championships 2024 yang berlangsung di Riyadh. Pencapaian ini  mempertegas posisi Indonesia sebagai salah satu negara terkuat dalam esports dunia.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Gelar juara umum ini diraih atas perolehan 1 medali emas di nomor MLBB Women, 1 medali perunggu di nomor MLBB Men, dan pencapaian peringkat ke-5 dunia di nomor PUBG Mobile. Sukses ini mengulang prestasi yang sebelumnya diraih pada IESF World Esports Championships 2022 di Bali, sekaligus memperpanjang daftar pencapaian Indonesia di berbagai ajang internasional.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sorotan utama di Riyadh jatuh pada Timnas MLBB Women Indonesia, yang tampil gemilang dan membawa pulang emas setelah mengalahkan Timnas Kamboja di babak final. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dengan strategi matang, eksekusi presisi, dan kekompakan yang luar biasa, mereka mendominasi pertandingan dan menutup final dengan skor telak. Skuad MLBB Women ini diperkuat oleh pemain-pemain andalan seperti Venny “Fumi” Lim, Cindy “Cinny” Laurent Siswanto, Viorelle “Vival” Valencia Chen, Michelle “Chell” Denise Siswanto, dan Vivi “Vivian” Indrawaty. Setiap anggota tim memainkan perannya dengan sempurna, membuat lawan-lawannya sulit untuk mengimbangi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Julukan "Timnas Bumi," yang diberikan oleh netizen, mencerminkan dominasi mereka di arena kompetisi. Tak hanya di level nasional, mereka kini diakui sebagai salah satu tim MLBB Women terbaik di dunia, menjadi inspirasi bagi para penggemar esports.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Yang menarik, tim ini juga mencuri perhatian karena latar belakang pendidikan mereka. Rata-rata anggota Timnas MLBB Women Indonesia adalah mahasiswa atau lulusan perguruan tinggi terkemuka. Mereka membuktikan bahwa komitmen terhadap pendidikan dan prestasi di esports bisa berjalan beriringan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ketua Umum PB ESI, Budi Gunawan menyebut keberhasilan ini sebagai bukti nyata dari visi besar PB ESI untuk menjadikan Indonesia sebagai pusat pengembangan esports dunia.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Desain besar PB ESI adalah menjadikan Indonesia salah satu kekuatan utama di Asia dan pusat esports dunia. Pada Musornas Oktober lalu, kami menegaskan komitmen serius untuk membawa esports Indonesia mendunia. Keberhasilan di Riyadh ini menjadi bukti bahwa Timnas Esports Indonesia adalah salah satu yang terkuat di dunia,” pungkasnya dalam keterangan tertulis, Jumat 22 November 2024.rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaOlahraga2;