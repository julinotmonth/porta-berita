...
import img_bisnis_4 from "../img/img_bisnis_4.jpeg"
import rina from "../img/reni.jpg"
import img_bisnis_7 from "../img/img_bisnis_7.jpeg"

function BeritaBisnis7 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Rencana Kenaikan PPN Tuai Kontroversi, Petisi Tolak 12 Persen Dapat Ribuan Dukungan
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 11:23 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi kenaikan PPN 12 persen/Instagram @topcareer.id
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Rencana pemerintah untuk menaikkan Pajak Pertambahan Nilai (PPN) menjadi 12 persen yang akan berlaku mulai 1 Januari 2025 menuai kritik tajam dari warganet di media sosial. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dalam beberapa hari terakhir, topik "PPN 12 persen" menjadi viral bahkan masuk menjadi Trending Topic di Media Sosial X Indonesia, yang memicu diskusi hangat di kalangan masyarakat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebagai bentuk protes, ribuan orang telah menandatangani petisi penolakan kenaikkan PPN dari 11 persen menjadi 12 persen pada tahun 2025. Sebagian besar warganet menilai kebijakan tersebut akan semakin membebani perekonomian masyarakat yang saat ini masih terpuruk.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Petisi yang diunggah melalui laman change.org ini terpantau telah mendapatkan 2.932 tanda tangan hingga Kamis, 21 November 2024, pukul 10.54 WIB. Petisi ini dibuat oleh akun X @barengwarga sebagai penggerak aksi tersebut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam petisinya, akun tersebut mengungkapkan bahwa rencana pemerintah untuk menaikkan PPN menjadi 12 persen justru akan memperburuk keadaan ekonomi masyarakat. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kenaikan ini diperkirakan akan mendorong harga barang-barang kebutuhan, mulai dari sabun mandi hingga Bahan Bakar Minyak (BBM), yang pada gilirannya akan menurunkan daya beli masyarakat.
                                                    </p>
                                                </div>
