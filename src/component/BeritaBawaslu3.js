                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bawaslu Selesaikan 137 Sengketa Paslon Pilkada dengan KPU
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 08:32 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bawaslu_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Bawaslu RI Rahmat Bagja/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Ketua Badan Pengawas Pemilihan Umum (Bawaslu), Rahmat Bagja mengungkapkan hasil penanganan sengketa pasangan calon kepala daerah dengan Komisi Pemilihan Umum Daerah (KPUD), yang tercatat berakhir 10 hari jelas pencoblosan.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Bagja mengatakan, hingga 17 November 2024, Bawaslu provinsi dan kabupaten/kota telah menangani sebanyak 137 permohonan sengketa antara paslon Pilkada Serentak 2024 dengan penyelenggara pemilihan.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Permohonan tersebut telah melalui proses verifikasi syarat formil dan materiil yang kemudian ada yang memenuhi syarat untuk diregister dan ada yang tidak memenuhi syarat," ujar Bagja dalam keterangan tertulis yang dilansir laman bawaslu.go.id, dikutip pada Jumat, 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Anggota Bawaslu RI dua periode itu merinci, terdapat 86 permohonan sengketa diregister untuk ditindaklanjuti, 41 permohonan tidak diregister karena tidak memenuhi syarat, 9 permohonan dinyatakan tidak dapat diterima, dan 1 permohonan masih dalam proses verifikasi. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dikatakan Bagja, dari 86 permohonan yang diregister menghasilkan beberapa putusan, yaitu 26 permohonan diselesaikan melalui kesepakatan antara para pihak, 34 permohonan ditolak, 18 permohonan dikabulkan sebagian, 2 permohonan dikabulkan seluruhnya serta 6 permohonan dinyatakan gugur karena berbagai alasan, seperti pencabutan permohonan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Bagja juga menjelaskan alur sengketa antara peserta dan penyelenggara pemilihan, dimana prinsip penyelesaian sengketa antar peserta, serta pendekatan musyawarah dalam menangani sengketa antarpeserta.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Setelah diregister, permohonan tersebut ditangani melalui musyawarah penyelesaian sengketa di Bawaslu daerah masing-masing," urainya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Bawaslu tidak hanya bertugas memastikan proses pemilu dan pemilihan berjalan sesuai aturan, tetapi juga menjadi penengah yang adil ketika terjadi perselisihan antara peserta maupun antara peserta dengan penyelenggara," demikian Bagja menambahkan. rmol news logo article
                                                    </p>
                                                </div>
