                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Dana White, Sosok di Balik Kesuksesan UFC
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 17:59 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_5} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">CEO UFC, Dana White/UFC
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Popularitas organisasi seni bela diri campuran, Ultimate Fighting Championship (UFC) tidak bisa dilepaskan dari sosok CEO Dana White.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Di bawah kepemimpinan Dana White sejak tahun 2001, UFC kian berkembang pesat hingga menjadi fenomena global dengan jutaan penggemar.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Melalui Dana White pula, aturan MMA lebih jelas dan ketat demi meningkatkan keselamatan para petarung. Ia juga menghapuskan unsur-unsur kekerasan yang tidak perlu dan memperkenalkan regulasi yang lebih baik dalam setiap pertarungan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Berkat kebijakan tersebut, UFC mendapatkan pengakuan dari otoritas olahraga, jaringan televisi, dan sponsor besar yang sebelumnya menghindari MMA karena ketidakpastian regulasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam perjalanannya, UFC sempat mengalami kesulitan finansial dan kurang mendapatkan pengakuan mainstream di awal tahun 2000-an.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Beruntung situasi berubah ketika Dana White memperkenalkan UFC kepada dua investor besar, yaitu Lorenzo dan Frank Fertitta, yang kemudian membeli UFC.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebelum kepemilikan Fertitta, UFC hampir bangkrut dan menghadapi tekanan hukum yang besar. UFC dipandang sebagai olahraga yang brutal dan liar, dengan banyak kritik mengenai keamanannya. rmol news logo article
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
...
export default BeritaOlahraga5;