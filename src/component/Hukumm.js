                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik">Hukum</h1>
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/1">
                                                <img src={hukum_1} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 12:35
                                                </span>
                                                <Link to="read/1" className="link_berita_politik">OTT Bengkulu Terkait Pungutan Dana Pilkada</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/2">
                                                <img src={hukum_2} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 12:03
                                                </span>
                                                <Link to="read/2" className="link_berita_politik">Terjaring OTT KPK, Gubernur Bengkulu Rohidin Punya Harta Rp4,1 Miliar</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/3">
                                                <img src={hukum_3} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 11:53</span>
                                                <Link to="read/3" className="link_berita_politik">Prabowo Diyakini Izinkan Menteri Budi Arie Diperiksa Polisi</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/4">
                                                <img src={hukum_4} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 10:51
                                                </span>
                                                <Link to="read/4" className="link_berita_politik">Ini Fakta Gubernur Bengkulu yang Kena OTT KPK</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/5">
                                                <img src={hukum_5} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 09:26
                                                </span>
                                                <Link to="read/5" className="link_berita_politik">KPK Amankan Uang saat OTT 7 Orang di Bengkulu
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/6">
                                                <img src={hukum_6} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 08:14
                                                </span>
                                                <Link to="read/6" className="link_berita_politik">Hasil OTT di Bengkulu Dipaparkan ke Pimpinan KPK Sore Ini</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/7">
                                                <img src={hukum_7} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 07:07
                                                </span>
                                                <Link to="read/7" className="link_berita_politik">KPK Benarkan Amankan 7 Orang dalam OTT di BengkuluKPK Benarkan Amankan 7 Orang dalam OTT di Bengkulu</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/8">
                                                <img src={hukum_8} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 06:42
                                                </span>
                                                <Link to="read/8" className="link_berita_politik">KPK Tanpa OTT Ibarat Polisi Tanpa Pistol dan Borgol</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
