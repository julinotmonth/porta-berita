                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Pelajari Teknologi Drone, Irjen TNI Sambangi Industri Pertahanan Afsel
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 03:39 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_pertahanan_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Irjen TNI Letnan Jenderal TNI H. Muhammad Saleh Mustafa di kantor Milkor, Cape Town, Afrika Selatan/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Inspektorat Jenderal (Irjen) TNI Letnan Jenderal TNI Muhammad Saleh Mustafa melaksanakan kunjungan ke Industri Pertahanan di Cape Town, Afrika Selatan (Afsel). </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Perusahaan Milkor merupakan industri pertahanan yang memproduksi Unmanned Aerial Vehicle (UAV) atau drone, senapan dan boat. Dalam kunjungannya, Irjen TNI diterima langsung Executive Chairman Milkor, Mr Tarik Imre pada Senin, 18 November 2024 lalu.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada kesempatan itu, Irjen TNI mengucapkan terima kasih atas sambutan yang hangat dari pihak Milkor.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ia menyampaikan harapan dan peluang kerja sama antara TNI dan Milkor dalam pemenuhan Alutsista berupa drone dan transfer teknologi diperlukan demi terwujudnya interoperability bagi TNI. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu Irjen TNI juga menyampaikan kerja sama ini harus saling menguntungkan bagi kedua belah pihak dan sekaligus mengundang untuk dapat berinvestasi di Indonesia. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Sehingga nantinya dapat memberikan dampak yang signifikan bagi Indonesia khususnya di bidang pertahanan dan keamanan,” ujar Saleh dalam keterangan yang diterima redaksi, Selasa, 19 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selanjutnya pihak Milkor mempresentasikan profil dan produk serta memperlihatkan beberapa workshop tempat pembuatan UAV, Communication System, Avionic System dan GCS (Ground Control Station). 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dan yang tidak kalah penting, pihak Milkor turut berpartisipasi dalam kegiatan Indo Defence yang rencananya akan digelar pada bulan Agustus 2025 mendatang.
                                                    </p>
                                                </div>
...
export default BeritaPertahanan3;