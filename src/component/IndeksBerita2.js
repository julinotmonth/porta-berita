                        ...
                        <Row>
                            ...
                            <Col xl={8} className=" display_none">
                                <div className="wadah_pagination margin_bottom_pagi">
                                    <Link to="/indeksberita" className="link_arrow_left margin_right_pagination">
                                    ...
                                    <Link to="/indeksberita/3" className="link_arrow_left">
