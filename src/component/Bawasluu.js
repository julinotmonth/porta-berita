                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik">Bawaslu</h1>
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/1">
                                                <img src={bawaslu_1} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 04:06
                                                </span>
                                                <Link to="read/1" className="link_berita_politik">Gandeng Polisi, Bawaslu Kota Tasikmalaya Bikin Tim Patroli Cegah Politik Uang</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/2">
                                                <img src={bawaslu_2} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">23 November 2024 10:48
                                                </span>
                                                <Link to="read/2" className="link_berita_politik">Bawaslu Instruksikan Jajaran Patroli di Masa Tenang</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/3">
                                                <img src={bawaslu_3} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">
                                                22 November 2024 08:32</span>
                                                <Link to="read/3" className="link_berita_politik">Bawaslu Selesaikan 137 Sengketa Paslon Pilkada dengan KPU</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/4">
                                                <img src={bawaslu_4} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">21 November 2024 10:07
                                                </span>
                                                <Link to="read/4" className="link_berita_politik">Pemilih Patut Waspadai Kerawanan di TPS Pilkada</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/5">
                                                <img src={bawaslu_5} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">20 November 2024 18:27
                                                </span>
                                                <Link to="read/5" className="link_berita_politik">Bawaslu: Endorse Prabowo untuk Luthfi-Yasin Bukan Pelanggaran
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/6">
                                                <img src={bawaslu_6} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">20 November 2024 13:59
                                                </span>
                                                <Link to="read/6" className="link_berita_politik">Bawaslu Gandeng Polri Cegah Pembacokan di Sampang Terulang</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/7">
                                                <img src={bawaslu_7} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">20 November 2024 12:21
                                                </span>
                                                <Link to="read/7" className="link_berita_politik">Wapres Ingatkan Bawaslu Cegah Kejadian Paslon Dibacok di Sampang Terulang</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/8">
                                                <img src={bawaslu_8} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">19 November 2024 18:29
                                                </span>
                                                <Link to="read/8" className="link_berita_politik">Rawan Pelanggaran, Bawaslu Gelar Simulasi Pengawasan Pencoblosan Pilkada 2024</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
