...
import img_politik_3 from "../img/politik_read_3.jpg"
import alfian from "../img/alfian.jpg"

function BeritaPolitik3 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Diingatkan Megawati, Aparatur Negara Tak Netral di Pilkada Bisa Dipidana</h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 18:12 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Umum PDIP Megawati Soekarnoputri/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Netralitas aparatur negara terus disorot jelang pelaksanaan Pemilihan Kepala Daerah (Pilkada) serentak 2024 yang hanya tinggal beberapa hari lagi. Terlebih, aparatur yang tidak netral pada pesta demokrasi bisa dipidana.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Melalui video singkat yang diputar di DPP PDIP, Rabu 20 November 2024, Presiden ke-5 RI, Megawati Soekarnoputri, menyerukan kepada seluruh pejabat negara, kepala daerah, TNI, Polri, hingga aparatur sipil negara (ASN) dan kepala desa untuk bersikap netral dan tidak berpihak demi menjaga demokrasi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Megawati menegaskan bahwa Mahkamah Konstitusi (MK) telah memberikan landasan hukum tegas melalui Putusan MK 136/PUU-XXII/2024 yang menyatakan bahwa aparatur yang melanggar netralitas dapat dikenakan sanksi pidana berupa penjara 1-6 bulan dan/atau denda Rp600 ribu hingga Rp6 juta.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Dengan landasan hukum tersebut kepada seluruh rakyat Indonesia tidak perlu ragu dan takut di dalam menghadapi berbagai intimidasi," kata Megawati.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pesan Ketua Umum PDIP itu menjadi pengingat bahwa proses demokrasi harus dijaga dengan integritas dan keadilan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Siapapun yang berniat curang dan tidak demokratis akan berhadapan dengan kekuatan rakyat," tegasnya.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pilkada Serentak dijadwalkan berlangsung pada 27 November 2024 dan menjadi momentum penting dalam menentukan arah kepemimpinan di tingkat daerah untuk lima tahun ke depan. rmol news logo article
                                                    </p>
                                                </div>
