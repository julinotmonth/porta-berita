...
import img_politik_4 from "../img/img_politik_4.jpg"

function BeritaPolitik4 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Tinjau Banjir Rob di Jakut, Gibran Minta Pembangunan Tanggul Pantai Dikebut
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 17:57 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wakil Presiden Gibran Rakabuming Raka didampingi Penjabat Gubernur Jakarta Teguh Setyabudi saat meninjau banjir rob di Jakarta Utara/Istimewa
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Banjir rob yang kerap terjadi di kawasan Jakarta Utara mendapat perhatian khusus dari Wakil Presiden Gibran Rakabuming Raka. Hal ini ditunjukkan Gibran saat meninjau kawasan Muara Angke, Penjaringan, Jakarta Utara yang terkena banjir rob dengan didampingi Penjabat Gubernur DKI Jakarta Teguh Setyabudi.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Usai peninjauan, Teguh mengatakan, salah satu penyebab banjir di pesisir Jakarta adalah rob atau meluapnya air laut. Untuk mengatasi hal ini, Pemprov DKI Jakarta akan melakukan percepatan pembangunan tanggul pantai di kawasan Muara Angke.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Wapres Gibran minta banjir rob bisa segera diatasi, dan masalah utamanya adalah tanggul pantai. Jadi InsyaAllah tahun depan kita segerakan pembangunannya,” kata Teguh, Rabu 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Teguh menyampaikan kepada Wapres Gibran bahwa Pemprov sudah mengambil langkah cepat dalam mengatasi banjir rob di kawasan pesisir Jakarta Utara. Yaitu pembuatan sodetan untuk mempercepat aliran air masuk ke laut saat air laut pasang. Sodetan ini akan membuat air yang menggenang cepat surut karena langsung dialirkan ke laut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam tinjauan tersebut, Teguh bersama Gibran juga melihat kondisi jalan dan rumah warga Muara Angke yang terkena dampak banjir rob. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara itu, Gibran menekankan agar koordinasi berbagai pihak semakin diperkuat sebagai upaya penanganan banjir. Ia mengimbau untuk mempercepat pembangunan infrastruktur pengendali banjir yang terintegrasi, termasuk proyek pembuatan tanggul yang direncanakan untuk melindungi Jakarta dari dampak kenaikan permukaan air laut.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Wapres menilai, penanganan banjir bukan hanya tanggung jawab satu generasi, tetapi warisan yang harus dipersiapkan untuk generasi mendatang. 
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Oleh karena itu, setiap langkah harus dirancang dengan visi jangka panjang demi masa depan yang lebih aman dan berkelanjutan. rmol news logo article
                                                    </p>
                                                </div>
