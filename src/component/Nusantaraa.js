...
import nusantara_1 from "../img/nusantara_1.jpeg"
import nusantara_2 from "../img/nusantara_2.jpeg"
import nusantara_3 from "../img/nusantara_3.jpeg"
import nusantara_4 from "../img/nusantara_4.jpg"
import nusantara_5 from "../img/nusantara_5.jpg"
import nusantara_6 from "../img/nusantara_6.jpg"
import nusantara_7 from "../img/nusantara_7.jpeg"
import nusantara_8 from "../img/nusantara_8.jpg"
                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik">Nusantara</h1>
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/1">
                                                <img src={nusantara_1} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 20:00
                                                </span>
                                                <Link to="read/1" className="link_berita_politik">Kemenparekraf Salurkan DPUP agar Desa Wisata Bebas Pinjol</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/2">
                                                <img src={nusantara_2} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 18:48
                                                </span>
                                                <Link to="read/2" className="link_berita_politik">Ada Aroma Adu Domba di Balik Polemik PSN PIK-2</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/3">
                                                <img src={nusantara_3} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 15:59
                                                </span>
                                                <Link to="read/3" className="link_berita_politik">Demo Ikatan Santri DKI Minta PKS Pecat Suswono</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/4">
                                                <img src={nusantara_4} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 15:44
                                                </span>
                                                <Link to="read/4" className="link_berita_politik">Wamenkop: Koperasi Selamatkan Masyarakat dari Rentenir</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/5">
                                                <img src={nusantara_5} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 13:10
                                                </span>
                                                <Link to="read/5" className="link_berita_politik">Anggota DPRD Labura Ahmad Fauzi Gelar Roadshow Program Jumat Berkah
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/6">
                                                <img src={nusantara_6} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 10:52
                                                </span>
                                                <Link to="read/6" className="link_berita_politik">Ini Jurus Pemprov DKI Halau Banjir</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/7">
                                                <img src={nusantara_7} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 10:42
                                                </span>
                                                <Link to="read/7" className="link_berita_politik">Pemuda Pelopor Pendidikan Ajak Anak Muda Indonesia Mahir dalam Berkomunikasi</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/8">
                                                <img src={nusantara_8} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 07:29
                                                </span>
                                                <Link to="read/8" className="link_berita_politik">Hujan Diperkirakan Basahi Jakarta Sore Hari</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
