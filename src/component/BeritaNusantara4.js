                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Wamenkop: Koperasi Selamatkan Masyarakat dari Rentenir
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 22 November 2024, 15:44 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_nusantara_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Wamenkop Ferry Juliantono saat membuka Rakernas dan Munaslub Perhimpunan BMT Indonesia di Padang, Sumatera Barat/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Baitul Maal Wa Tamwil (BMT) atau koperasi memiliki peran penting dalam penguatan ekonomi dan sosial. Kedua fungsi ini saling terikat sehingga keberadaan koperasi atau BMT mutlak harus diberikan dukungan penuh oleh pemerintah.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Hal ini diungkap Wakil Menteri Koperasi (Wamenkop) Ferry Juliantono saat membuka Rapat Kerja Nasional (Rakernas) dan Musyawarah Nasional Luar Biasa (Munaslub) Perhimpunan BMT Indonesia di Padang, Sumatera Barat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ferry menjelaskan, untuk peran koperasi dalam ranah ekonomi adalah mensejahterakan anggota sehingga koperasi termasuk BMT harus mencatatkan keuntungan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sementara untuk fungsi sosial adalah menuntaskan jeratan utang masyarakat kelompok paling bawah (mikro dan ultra mikro) dari rentenir yang banyak beredar di masyarakat. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Koperasi harus jadi tempat kita untuk saling gotong royong, saling membantu dan saling menguatkan. Saya merasakan sendiri di KSPPS BMT Jati Baru di Padang dimana peran mereka membantu melepaskan jeratan utang masyarakat dari rentenir," kata Ferry seperti dikutip redaksi, Jumat 22 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Wamenkop menambahkan, dengan dua fungsi tersebut, koperasi atau BMT menjadi solusi yang relevan untuk mengatasi permasalahan kemiskinan ekstrim yang ada di tengah masyarakat. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebagaimana diketahui, Badan Pusat Statistik (BPS) mencatat jumlah penduduk miskin di Indonesia hingga Maret 2024 sebanyak 25,22 juta orang atau turun 0,33 persen dibanding tahun sebelumnya sebesar 25,9 juta orang.
                                                    </p>
                                                </div>
...
export default BeritaNusantara4;