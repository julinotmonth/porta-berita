                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Amazon Kembangkan Kacamata GPS untuk Kurir
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Jumat, 15 November 2024, 15:02 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_teknoo_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Kurir Amazon/Tangkapan layar RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Raksasa ritel Amerika Serikat (AS) Amazon sedang mengembangkan kacamata pintar yang dilengkapi pemandu arah untuk membantu kurirnya mempercepat pengantaran barang.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Sumber dalam industri yang mengetahui rencana tersebut mengatakan, kacamata tersebut nantinya akan menyediakan navigasi belokan demi belokan kepada pengemudi pada layar kecil yang tertanam, di sepanjang rute mereka dan di setiap pemberhentian.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dikatakan bahwa petunjuk seperti itu dapat menghemat detik-detik berharga pada setiap pengiriman dengan memberikan petunjuk arah ke kiri atau kanan saat keluar dari lift dan di sekitar rintangan seperti gerbang atau anjing agresif.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dikutip dari Reuters, Jumat 15 November 2024, dengan kacamata pintar ini, kurir akan terbebas dari penggunaan perangkat Sistem Pemosisian Global (GPS) genggam, sehingga mereka dapat membawa lebih banyak paket.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Orang-orang memperingatkan bahwa kacamata pengiriman Amazon dapat ditangguhkan atau ditunda tanpa batas waktu jika tidak berfungsi seperti yang diharapkan, atau karena alasan keuangan atau alasan lainnya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sumber anonim mengatakan bahwa kacamata tersebut mungkin memerlukan waktu bertahun-tahun untuk disempurnakan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kami terus berinovasi untuk menciptakan pengalaman pengiriman yang lebih aman dan lebih baik bagi pengemudi," kata juru bicara Amazon, saat ditanya tentang kacamata pengemudi.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Proyek baru Amazon jelas dilakukan sebagai upaya untuk mengurangi biaya pengiriman paket dan mendukung margin di tengah persaingan ketat dengan Walmart yang telah meningkatkan upaya e-commerce dan memangkas harga. 
                                                    </p>
                                                </div>
