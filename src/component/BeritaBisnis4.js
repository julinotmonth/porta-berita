                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Bos-bos BUMN Berganti, Erick Tegaskan Kepemimpinan Memiliki Batasan Waktu
                                    </h1>
                                </div>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_4} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ilustrasi/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Perubahan susunan manajemen, baik Komisaris dan Direksi di perusahaan pelat merah merupakan sesuatu yang lumrah terjadi</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Menteri Badan Usaha Milik Negara (BUMN) Erick Thohir menyampaikan perubahan dapat dilakukan ketika diperlukan. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Erick menegaskan, semua kepemimpinan di BUMN memiliki batasan waktu. Salah satu contohnya, mantan Direktur Utama PT Pertamina (Persero) Nicke Widyawati, yang menjabat hingga 7 tahun.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Bu Nicke, beliau berhasil tetapi kan sudah 7 tahun, Dirut Pertamina terlama. Sekarang Pak Simon (Simon Aloysius Mantiri) masuk. Saya rasa sebuah transisi yang baik, tidak ada istilahnya nanti malah sebuah kebijakan yang set back, justru ini akan jadi keberlanjutan," kata Erick, dalam pernyataan di Jakarta, dikutip Kamis 21 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sebelumnya, ada beberapa posisi Komisaris dan Direksi BUMN yang dirubah.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Mulai dari PT Pertamina (Persero), PT PLN (Persero), PT LEN Industri (Persero) dan PT Pindad, hingga yang terbaru, PT ASDP Indonesia Ferry (Persero).
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam Rapat Umum Pemegang Saham (RUPS) PT ASDP Indonesia Ferry (Persero) memutuskan mengubah susunan pengurus pada Selasa, 19 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Hasil RUPS ASDP Indonesia Ferry menyepakati pergantian jajaran Dewan Komisaris dan perubahan nomenklatur Direksi Perseroan sebagai bagian dari langkah strategis perusahaan. 
                                                    </p>
                                                </div>
