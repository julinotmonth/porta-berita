...
import img_bisnis_9 from "../img/img_bisnis_9.jpeg"


function BeritaBisnis9 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Salah Satu Orang Terkaya di Asia Terjerat Kasus Suap Jumbo, Didakwa Pengadilan AS
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 10:29 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_9} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Gautam Adani/Reuters
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Miliarder India Gautam Adani didakwa atas tuduhan penyuapan di pengadilan federal AS pada Rabu  20 November 2024, waktu setempat.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Jaksa menuduh pria berusia 62 tahun itu dan eksekutif India lainnya menjanjikan lebih dari 250 juta Dolar AS (Rp3,9 triliun) kepada pejabat pemerintah India untuk mendapatkan kontrak energi surya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Sebagaimana yang dituduhkan, para terdakwa mengatur skema rumit untuk menyuap pejabat pemerintah India untuk mendapatkan kontrak senilai miliaran dolar," kata Breon Peace, jaksa AS untuk Distrik Timur New York,  dikutip dari Nikkei Asia, Kamis 21 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pengadilan juga mendakwa Adani dan yang lainnya dengan penipuan sekuritas dan kawat atas dugaan peran mereka dalam skema bernilai miliaran Dolar untuk merayu investasi dari AS dan tempat lain atas dasar pernyataan palsu.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menurut dakwaan, Adani, keponakannya, Sagar Adani, dan enam terdakwa lainnya diduga menawarkan suap sebesar 265 juta Dolar AS kepada pejabat pemerintah India antara tahun 2020 dan 2024 demi mendapatkan kontrak pasokan energi surya dan menguntungkan perusahaan energi terbarukan India yang terkait dengan Gautam Adani. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Nama perusahaan tersebut tidak diungkapkan dalam dakwaan, namun proyek itu diperkirakan  menghasilkan lebih dari 2 miliar Dolar AS selama periode dua dekade dalam laba setelah pajak.
                                                    </p>
                                                </div>
