                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">KPK Tanpa OTT Ibarat Polisi Tanpa Pistol dan Borgol
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 06:42 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_8} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Tangkapan layar Sudirman Said/Repro
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Pelemahan terhadap institusi KPK terjadi secara masif di era pemerintahan Presiden Joko Widodo (Jokowi).</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Hal itu diungkapkan Menteri ESDM periode 2014-2016, Sudirman Said yang menyoroti pernyataan Prof. Mahfud MD terkait kondisi pemberantasan korupsi belakangan ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sudirman menyebut adanya revisi UU KPK menjadi awal mula proses pelemahan itu. Kemudian terkait adanya oknum pegawai KPK yang melakukan pemerasan juga menandai bobroknya kondisi lembaga antirasuah ini.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Kemudian sebaliknya, ironisnya adalah pegawai-pegawai, penyidik-penyidik (KPK) yang punya kekuatan moral dan integritas dan juga kompetensi malah terkena screening melalui yang disebut sebagai tes wawasan kebangsaan. Kita juga tahu semua ini,” ucap Sudirman dikutip RMOL dari kanal Youtube Satu Visi Utama, Sabtu malam, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Jadi, sudah hukumnya dilemahkan oleh pimpinan tertinggi pada waktu itu, kemudian praktik di dalamnya mengalami pelemahan oleh para pimpinan maupun oknum pegawainya sendiri. Sementara elemen yang menjadi pendukung utama yang menjadi kekuatan malah disingkirkan,” tamabahnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Hari ini kita mendapat berita menarik karena baru saja terpilih 5 pimpinan KPK yang baru melalui proses bidang fit and proper test DPR. Dan ada kejadian yang ditulis oleh Harian Kompas cukup panjang hari ini, yaitu bagaimana anggota DPR itu menyambut dengan tepuk tangan karena salah satu calon pimpinan yang terpilih dan sekarang terpilih, itu menyampaikan pandangan akan menghapus OTT. Ini seperti polisi yang saya tidak akan lagi menggunakan pistol atau borgol,” bebernya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Seandainya bisa jadi, mohon izin, jadi ketua, saya akan tutup, close (OTT). Karena itu tidak sesuai pengertian yang dimaksud dalam KUHAP," kata Tanak yang diiringi tepuk tangan seisi ruangan Komisi III DPR pada Rabu, 19 November 2024. rmol news logo article
                                                    </p>
                                                </div>
