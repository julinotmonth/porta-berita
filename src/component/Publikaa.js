...
import publika_1 from "../img/publika_1.jpg"
import publika_2 from "../img/publika_2.jpg"
import publika_3 from "../img/publika_3.jpg"
import publika_4 from "../img/publika_4.jpg"
import publika_5 from "../img/publika_5.jpg"
import publika_6 from "../img/publika_6.jpg"
import publika_7 from "../img/publika_7.jpg"
import publika_8 from "../img/publika_8.jpeg"
                    ...
                    <div className="wadah_berita_politik">
                        <Row>
                            <Col xl={8} lg={12} md={12} sm={12} xs={12} className="padding_bottom_column">
                                <h1 className="content_politik">Publika</h1>
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/1">
                                                <img src={publika_1} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 13:04
                                                </span>
                                                <Link to="read/1" className="link_berita_politik">Menjaga Stabilitas di Tengah Pusaran Pilkada Maluku Utara</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/2">
                                                <img src={publika_2} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">24 November 2024 07:22
                                                </span>
                                                <Link to="read/2" className="link_berita_politik">Mau Enggak, Nurut?</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/3">
                                                <img src={publika_3} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">
                                                23 November 2024 09:52</span>
                                                <Link to="read/3" className="link_berita_politik">Musuh Utama Jokowi itu Ya Habib Rizieq
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/4">
                                                <img src={publika_4} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">23 November 2024 09:07
                                                </span>
                                                <Link to="read/4" className="link_berita_politik">Media Demokrasi</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/5">
                                                <img src={publika_5} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 23:52
                                                </span>
                                                <Link to="read/5" className="link_berita_politik">Syahwat Politik Jokowi di Jawa Tengah: Ancaman Bagi Demokrasi
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/6">
                                                <img src={publika_6} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 10:22
                                                </span>
                                                <Link to="read/6" className="link_berita_politik">Ridwan Kamil dan Jakarta Gemilang</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/7">
                                                <img src={publika_7} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                ...
                                                <Link to="read/7" className="link_berita_politik">Akhaffu Dhararain</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                ...
                                <div className="wadah_berita_keluar margin_bottom_content_politik margin_right_wadah_politik">
                                    <Row>
                                        <Col xl={2} lg={2} md={2} sm={3} xs={3}>
                                            <Link to="read/8">
                                                <img src={publika_8} className="img_berita_politik" />
                                            </Link>
                                        </Col>
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                <span className="tanggal_berita_keluar">22 November 2024 04:56
                                                </span>
                                                <Link to="read/8" className="link_berita_politik">Menyambut Tahun Koperasi Internasional</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
