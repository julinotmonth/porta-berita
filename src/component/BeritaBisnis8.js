...
import img_bisnis_8 from "../img/img_bisnis_8.jpeg"


function BeritaBisnis8 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ketegangan Rusia-Ukraina Meningkat Lagi, Harga Emas Dunia Melonjak
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 11:11 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_8} className="content_img_post_berita" />
                                </div>
                                ...
                                <div className="wadah_deskripsi_post_1">
                                    ...
                                    <span className="span_deskripsi_post_1">Harga emas dunia terpantau kembali menguat pada penutupan perdagangan Rabu 20 November 2024 waktu setempat.
                                    </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Menurut data pasar, harga emas spot (XAU/USD) tercatat melonjak 0,68 persen ke level 2.649,90 Dolar AS per troy ons, seiring dengan meningkatnya ketegangan konflik antara Ukraina dan Rusia.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Kenaikan ini dipicu oleh meningkatnya ketegangan geopolitik yang mendorong  investor melakukan aksi beli aset aman (safe haven), salah satunya emas.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Langkah pemerintahan Amerika Serikat (AS) Joe Biden yang mengizinkan Ukraina menembakkan rudal buatan AS ke Rusia disusul dengan respons Moskow yang menurunkan ambang kebijakan penggunaan senjata nuklir membuat ketegangan di kawasan itu semakin meningkat.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ukraina sebelumnya juga menembakkan rudal buatan Inggris ke wilayah Rusia, menyusul serangan menggunakan rudal jarak jauh buatan AS sehari sebelumnya.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Tak hanya itu, sentimen kenaikan harga emas ini juga dipengaruhi oleh kemungkinan penurunan suku bunga Bank Sentral Amerika Serikat (AS) Federal Reserve (The Fed) pada pertemuan mendatang.
                                                    </p>
                                                </div>
