                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Kamis, 21 November 2024, 13:29 WIB</span>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                                <div className="wadah_img_post_berita">
                                    <img src={img_bisnis_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Konglomerat legendaris, Warren Buffet/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Perusahaan milik konglomerat Warren Buffett, Berkshire Hathaway memborong saham Domino's Pizza senilai 549 juta Dolar AS atau sekitar Rp8,7 triliun.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Seperti dikutip dari Business Insider Kamis 21 November 2024, Buffet membeli total 1,3 juta saham pengelola pizza itu atau sekitar 3,7 persen dari keseluruhan saham yang beredar.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, Buffet juga membeli 1,1 persen saham distributor dan mesin kolam renang multinasional, Pool Corp senilai 152 juta Dolar AS (Rp2,4 triliun).
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, pria berusia 94 tahun tersebut juga dikenal penikmat junk food. Berkshire memiliki kepemilikan saham di Dairy Queen, Coca-Cola, dan Kraft Heinz sehingga keputusan mengambil posisi di Domino's cocok dengan brand-brand yang dibeli Buffett. rmol news logo article

                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Buffett selama ini dikenal menggunakan pendekatan value investing untuk memburu saham-saham diskon. Harga saham Domino's sendiri diketahui telah meningkat lebih dari 40 kali lipat sejak tahun 2010 hingga mencapai 530 Dolar AS per saham pada akhir Juni, mendekati level tertinggi sepanjang masa ke 560 Dolar AS.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, sejak saat itu harga sahamnya terus anjlok hingga menyentuh ke level 400 Dolar AS pada pertengahan Juli dan terus tertekan. Kondisi ini menciptakan peluang bagi Berkshire untuk melakukan pembelian, di tengah menurunnya saham pengelola pizza itu. Pada tahun 2023 Domino's membukukan pendapatan sebesar 4,5 miliar Dolar AS.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
