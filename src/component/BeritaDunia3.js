                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Ini Rudal Oreshnik yang Diluncurkan Putin untuk Gempur Ukraina, Kecepatannya 2,5-3 Km per Detik
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Sabtu, 23 November 2024, 09:18 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_dunia_3} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Rudal balistik Oreshnik/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Pemerintah Rusia telah sangat siap menanggapi langkah-langkah terbaru pasukan Ukraina. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">PresidenVladimir Putin dalam pernyataannya pada Jumat malam, 23 November 2024, mengatakan pasukannya telah meluncurkan rudal "jarak menengah konvensional baru" dengan nama sandi Oreshnik, sebagai tanggapan terhadap Ukraina yang menggunakan rudal yang disediakan AS dan Inggris untuk menyerang negaranya. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Rusia pada Kamis meluncurkan serangan yang menurut para saksi mata tidak biasa, memicu ledakan dahsyat yang berlangsung selama tiga jam ke fasilitas pertahanan Ukraina di Dnepropetrovsk.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Sasarannya adalah Yuzhmash, salah satu fasilitas industri pertahanan terbesar Ukraina yang diwarisi dari Uni Soviet yang memproduksi peralatan rudal dan senjata lainnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Serangan itu melibatkan serangan rudal yang sangat kuat sehingga pejabat Ukraina mengatakan rudal itu memiliki karakteristik rudal balistik antarbenua (ICBM).  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Putin  mengatakan, "Oreshnik" berarti pohon hazel dalam bahasa Rusia. Putin mengatakan bahwa senjata itu melaju dengan kecepatan Mach 10, atau 2,5-3 km per detik (10 kali kecepatan suara), seraya menambahkan bahwa "saat ini tidak ada cara untuk menangkal senjata ini". 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Oreshnik digambarkan sebagai senjata hipersonik jarak menengah yang dirancang untuk serangan berpresisi tinggi. Menurut Kementerian Pertahanan, semua hulu ledak rudal tersebut mencapai target selama pengerahan minggu ini. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
