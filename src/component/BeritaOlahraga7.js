                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Garuda Tekuk Arab Saudi, Mardani: Kita Kawal Tak Ada Pengurangan Kuota Haji
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                ...
                                                <span className="content_name_reporter content_name_reporter_bold">WIDODO BOGIARTO
                                                </span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 08:44 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_olahraga_7} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Timnas Indonesia menang 2-0 atas Arab Saudi/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Kemenangan Timnas Indonesia 2-0 atas Arab Saudi dalam laga pekan keenam di Stadion Utama Gelora Bung Karno (SUGBK), Senayan, Jakarta, Selasa, 19 November 2024, disambut suka cita publik Tanah Air.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Salah satunya dirasakan oleh Ketua Badan Kerjasama Antar Parlemen (BKSAP) DPR RI, Mardani Ali Sera.   
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Politikus PKS ini mengapresiasi perjuangan mati-matian Rizky Ridho dkk di atas lapangan hijau demi Merah Putih menuju Piala Dunia 2026.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Alhamdulilah luar biasa. Mimpi World Cup tidak pernah sedekat ini. Terima kasih Garuda," tulis Mardani melalui akun Instagram pribadinya dikutip Rabu, 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Meski begitu, dengan nada bercanda, Mardani mengaku khawatir ada pengurangan kuota haji imbas kekalahan Arab Saudi. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Kita kawal agar tidak ada pengurangan haji setelah laga malam tadi," sambung Mardani dengan menambahkan emoji tertawa.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dalam laga malam tadi, Marselino Ferdinan mencetak dua pada menit ke-33 dan ke-57. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Hasil ini merupakan kemenangan pertama tim asuhan Shin Tae-yong di ronde ketiga Kualifikasi Piala Dunia 2026.rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaOlahraga7;