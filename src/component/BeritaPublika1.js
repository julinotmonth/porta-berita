                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Menjaga Stabilitas di Tengah Pusaran Pilkada Maluku Utara
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 13:04 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_publika_1} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Riswan Lagalante/Ist
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">PILKADA Serentak 2024 di Maluku Utara menjadi momen yang sangat penting bagi masa depan daerah ini. Sebagai bagian dari proses demokrasi, Pilkada harus dilaksanakan dengan jujur, adil, dan damai. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Agar pilkada berjalan dengan lancar, netralitas menjadi hal yang sangat krusial. Tidak hanya bagi penyelenggara, tetapi juga bagi aparat keamanan dan seluruh elemen masyarakat.    
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Dengan menjaga netralitas, pilkada bisa berlangsung dengan hasil yang benar-benar mencerminkan kehendak rakyat, tanpa adanya intervensi yang merugikan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Namun, sepanjang sejarah Pilkada Maluku Utara, sejumlah pelanggaran dan permasalahan seringkali muncul, mengancam pelaksanaan pesta demokrasi yang adil dan damai. Salah satu kasus yang cukup mencolok adalah pelanggaran yang melibatkan politik uang, intimidasi terhadap pemilih, dan ketidaknetralan aparat keamanan.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada pilkada sebelumnya, terdapat beberapa laporan tentang adanya pengaruh politik yang kuat dari pihak tertentu yang berusaha mengarahkan pilihan pemilih dengan cara yang tidak sah, termasuk distribusi uang untuk memenangkan kandidat tertentu. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, beberapa laporan juga mencatat adanya intimidasi yang dilakukan oleh oknum yang memaksa pemilih untuk memilih calon tertentu. Sebuah pelanggaran yang sangat merusak integritas demokrasi. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Peran Bawaslu sebagai lembaga pengawas pemilu sangat vital dalam mendeteksi dan menindak praktik-praktik tersebut agar pilkada tetap bersih.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada pilkada sebelumnya juga, meski upaya untuk menjaga netralitas aparat keamanan sudah dilakukan, masih ada laporan mengenai keberpihakan aparat di lapangan. 
                                                    </p>
                                                </div>
