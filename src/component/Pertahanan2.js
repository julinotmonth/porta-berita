                        ...
                        <Row>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={9} xs={9}>
                                            <div className="wadah_link_tanggal">
                                                ...
                                                <Link className="link_berita_politik">Setelah Pilates, Zita Anjani Ajak Ibu-Ibu Bikin Brownies Rendah Gula</Link>
                                            </div>
                                        </Col>
                                    </Row>
                                </div>
                            ...
                            <Col xl={8} className=" display_none">
                                <div className="wadah_pagination margin_bottom_pagi">
                                    <Link to="/pertahanan" className="link_arrow_left margin_right_pagination">
