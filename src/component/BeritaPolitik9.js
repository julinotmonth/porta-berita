...
import img_politik_9 from "../img/img_politik_9.jpg"

function BeritaPolitik9 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Budi Arie Merasa Dikhianati Anak Buah
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 16:36 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_9} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Mantan Menteri Komunikasi dan Informatika, Budi Arie Setiadi/Net
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Mantan Menteri Komunikasi dan Informatika, Budi Arie Setiadi, mengungkapkan keterlibatan sejumlah mantan anak buahnya dalam kasus judi online.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Dalam pernyataannya, Budi mengaku telah lama mencurigai adanya kebocoran di internal Kominfo, terutama di tim pengendalian situs judi online.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ketika mau di take down diberitahu dulu kepada pihak bandarnya. Hati-hati pihak lu mau di take down, ganti," kata Budi Arie saat menjadi narasumber kanal YouTube Deddy Corbuzier, Rabu 20 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Budi menjelaskan, saat pertama kali menjabat, ia mencari solusi percepatan untuk menangani situs judi online yang jumlahnya terus bertambah.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Ia sempat menerima rekomendasi dari seseorang berinisial T untuk bekerja sama dengan seorang hacker bernama Adhi Kiswanto, yang diklaim mampu men-take down hingga 100 ribu situs per hari. Namun, Budi belakangan mengetahui bahwa Adhi justru bermain di balik layar.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Si T rekomendasiin AK ternyata si AK main. Terus saya pikir, dia khianatin gua. Ada 100.000 ditakedown, ada 1.000 yang diumpetin,” ungkapnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Menindaklanjuti kecurigaannya, Budi memutuskan untuk mengganti tim pengendalian setiap tiga bulan sekali agar memastikan tidak ada konflik kepentingan.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"Ini rentang kendali saya sebagai menteri di bawah saya masih ada Dirjen Aptika, lalu ada lagi Direktur Pengendalian, lalu ada kepala tim yang ditangkap dan anggota berarti rentang komandonya ke saya ada 5 lapis ke bawah," tukasnya.
                                                    </p>
                                                </div>
                                                <div className="wadah_name_editor_org">
                                                    <span className="name_editor_org">EDITOR : </span>
                                                    <span className="name_editor_org bold_editor">AHMAD KIFLAN WAKIK</span>
                                                </div>
                                                <div className="wadah_icon_medsos_politik_1">
                                                    <Link className="link_icon_medsos_politik_1">
                                                        <img src={logo_wa} className="icon_medsos_politik" />
