...
import img_politik_14 from "../img/img_politik_14.jpg"

function BeritaPolitik14 () {
    return (
                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Komisi III DPR Fit and Proper Test 10 Cadewas KPK Hari Ini
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        <Col xl={1} lg={1} md={1} sm={1} xs={2}>
                                            <div className="wadah_profil_report_2">
                                                <img src={profile_report_1} className="content_img_profil_report" />
                                            </div>
                                        </Col>
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            <div className="wadah_name_reporter">
                                                <span className="content_name_reporter">REPORT : </span>
                                                <span className="content_name_reporter content_name_reporter_bold">FAISAL ARISTAMA</span>
                                            </div>
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Rabu, 20 November 2024, 09:13 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_politik_14} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Ketua Komisi III DPR RI, Habiburrokhman/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Komisi III DPR RI akan menggelar uji kepatutan dan kelayakan atau fit and proper test terhadap 10 orang Calon Dewan Pengawas (Cadewas) Komisi Pemberantasan Korupsi (KPK) pada Rabu, 20 November 2024. </span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Adapun Cadewas yang akan menjalani fit and proper test adalah Benny Jozua Mamoto, Chisca Mirawati, Elly Fariani, Gusrizal, Hamdi Hassyarbaini, Heru Kreshna Reza, Iskandar Mz, Mirwazi, Sumpeno, dan Wisnu Baroto.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Pada Selasa malam 19 November 2024, Komisi III DPR RI telah usai menggelar fit and proper test terhadap 10 calon pimpinan (Capim) KPK. Mereka adalah Agus Joko Pramono, Ahmad Alamsyah Saragih, Djoko Poerwanto, Fitroh Rohcahyanto, Ibnu Basuki Widodo, Ida Budhiati, Johanis Tanak, Michael Rolandi Cesnanta Brata, Poengky Indarti, dan Setyo Budiyanto.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">“Alhamdulillah. Oke Kita lanjut besok pukul 08.30 WIB, kita gaspol lagi biar masyarakat bisa melihat keseriusan kita Komisi III DPR RI, dedikasi kita malam ini masih begitu banyak teman-teman yang hadir soal. Kita skors sampai besok,” ujar Ketua Komisi III DPR RI, Habiburrokhman pada Selasa malam, 19 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Tahapan fit and proper test untuk Capim dan Cadewas KPK ini berlangsung mulai Senin 18 November hingga 21 November 2024. 
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Anies sendiri berpotensi gagal ikut kontestasi Pilkada Jakarta 2024. Padahal sebelumnya, dikabarkan PDIP akan mengusung Anies sebagai cagub Jakarta. </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Rencananya, pada Kamis 21 November nanti Komisi III akan menetapkan 5 dari 10 Calon Pimpinan dan Dewan Pengawas KPK periode 2024-2029.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">"(Penetapan Capim dan Cadewas KPK) Kamis malam jam 21.00 WIB," kata Habiburokhman.rmol news logo article
                                                    </p>
                                                </div>
...
export default BeritaPolitik14;