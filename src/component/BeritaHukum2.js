                        ...
                        <Col xl={8} lg={8} md={12} sm={12}>
                            <div className="wadah_content_berita_politik_all">
                                ...
                                <div className="wadah_judul_berita_politik_1">
                                    <h1 className="judul_berita_politik_1">Terjaring OTT KPK, Gubernur Bengkulu Rohidin Punya Harta Rp4,1 Miliar
                                    </h1>
                                </div>
                                    ...
                                    <Row>
                                        ...
                                        <Col xl={11} lg={11} md={11} sm={11} xs={10}>
                                            ...
                                            <div className="wadah_date_reporter_post">
                                                <span className="date_reporter_post">Minggu, 24 November 2024, 12:03 WIB
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                ...
                                <div className="wadah_img_post_berita">
                                    <img src={img_hukum_2} className="content_img_post_berita" />
                                </div>
                                <div className="wadah_span_img_post">
                                    <span className="content_span_img_post">Gubernur Bengkulu, Rohidin Mersyah saat diperiksa KPK kasus korupsi ekspor benur pada 2021 lalu/RMOL
                                    </span>
                                </div>
                                <div className="wadah_deskripsi_post_1">
                                    <img src={republik_merdeka} className="img_deskripsi_post_1" />
                                    <span className="span_deskripsi_post_1">Gubernur Bengkulu, Rohidin Mersyah yang turut terjaring operasi tangkap tangan (OTT) Komisi Pemberantasan Korupsi (KPK), tercatat punya harta sebesar Rp4,1 miliar.</span>
                                </div>
                                        ...
                                        <Col xl={10} lg={10} md={10} sm={10} xs={12}>
                                            <div className="wadah_berita_terkait_rmol">
                                                ...
                                                <div className="wadah_paragraf_berita_rmol">
                                                    <p className="content_paragraf_berita_rmol">Rohidin yang juga calon gubernur (Cagub) Bengkulu pada Pilkada 2024 ini menjadi salah satu pihak yang terjaring OTT KPK pada Sabtu, 23 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain Rohidin, KPK juga meringkus enam orang lainnya. Mereka pun akan dibawa ke Gedung Merah Putih KPK, Jalan Kuningan Persada Kav 4, Setiabudi, Jakarta Selatan pada siang ini, Minggu, 24 November 2024.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Lalu, berapa harta kekayaan Cagub Bengkulu petahana tersebut? Berdasarkan penelusuran di Laporan Harta Kekayaan Penyelenggara Negara (LHKPN) KPK, Rohidin terakhir menyerahkan LHKPN periode 2023 dengan nilai harta kekayaan sebesar Rp4,1 miliar.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Politisi Partai Golkar itu tercatat memiliki harta berupa tanah dan bangunan sebanyak 5 bidang di Kota Bengkulu, dan Kota Bengkulu Selatan senilai Rp2,6 miliar.  
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Selain itu, Ketua DPD Partai Golkar Bengkulu ini juga tercatat memiliki harta berupa alat transportasi dan mesin senilai Rp279 juta yang terdiri dari motor Honda tahun 2018 seharga Rp70 juta, mobil Toyota Harrier tahun 2010 seharga Rp200 juta, dan motor Honda tahun 2013 seharga Rp9 juta.
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Rohidin juga punya harta bergerak lainnya senilai Rp265 juta, kas dan setara kas sebesar Rp956.059.062. Rohidin tidak memiliki utang, sehingga total harta kekayaannya sebesar Rp4.100.059.062 (Rp4,1 miliar).
                                                    </p>
                                                </div>
                                                <div className="wadah_paragraf_berita_rmoll">
                                                    <p className="content_paragraf_berita_rmol">Rohidin Mersyah sebelumnya juga telah diperiksa KPK dalam kasus korupsi ekspor benih bening lobster (BBL) di Kementerian Kelautan dan Perikanan (KKP) pada Senin, 18 Januari 2021.rmol news logo article
                                                    </p>
                                                </div>
